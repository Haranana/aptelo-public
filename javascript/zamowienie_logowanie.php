...
$PlikCacheJs = 'cache/js/zamowienie_logowanie_' . $_SESSION['domyslnyJezyk']['kod'] . '.jcs';
...
if (!file_exists($PlikCacheJs) || CACHE_JS == 'nie') {
    ...
    $kod .= file_get_contents('javascript/zamowienie_logowanie.jcs');
...
$kod = str_replace( '{__TOKEN_LOGOWANIE}', (string)Sesje::Token(),(string)$kod );
$kod = str_replace( '{__TOKEN_LOGOWANIE_OKNO}', (string)Sesje::Token(), (string)$kod );
$kod = str_replace( '{__TOKEN_SPRAWDZENIE}', (string)Sesje::Token(), (string)$kod );
$kod = str_replace( '{__TOKEN_REJESTRACJA}', (string)Sesje::Token(), (string)$kod );   
$kod = str_replace( '{__TOKEN_REJESTRACJA_OKNO}', (string)Sesje::Token(), (string)$kod );
