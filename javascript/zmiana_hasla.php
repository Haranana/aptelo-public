...
$PlikCacheJs = 'cache/js/zmiana_hasla_' . $_SESSION['domyslnyJezyk']['kod'] . '.jcs';
...
if (!file_exists($PlikCacheJs) || CACHE_JS == 'nie') {
    ...
    $kod = '';
    $kod .= file_get_contents('javascript/zmiana_hasla.jcs');
...
$kod = str_replace( '{__TOKEN_ZMIANA_HASLA}', (string)Sesje::Token(), (string)$kod );
$kod = str_replace( '{__TOKEN_ZMIANA_HASLA_OKNO}', (string)Sesje::Token(), (string)$kod );
