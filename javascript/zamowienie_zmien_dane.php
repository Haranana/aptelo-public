...
$PlikCacheJs = 'cache/js/zamowienie_zmien_dane_' . $_SESSION['domyslnyJezyk']['kod'] . '.jcs';
...
if (!file_exists($PlikCacheJs) || CACHE_JS == 'nie') {
    ...
    $kod = '';
    $kod .= file_get_contents('javascript/zamowienie_zmien_dane.jcs');
...
$kod = str_replace( '{__TOKEN_ZAMOWIENIE_DANE}', (string)Sesje::Token(), (string)$kod );
$kod = str_replace( '{__TOKEN_ZAMOWIENIE_DANE_OKNO}',(string) Sesje::Token(), (string)$kod );
