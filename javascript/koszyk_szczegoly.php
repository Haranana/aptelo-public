...
$PlikCacheJs = 'cache/js/koszyk_szczegoly.jcs';
...
if (!file_exists($PlikCacheJs) || CACHE_JS == 'nie') {
    ...
    $kod = '';
    $kod .= file_get_contents('javascript/koszyk_szczegoly.jcs');
...
$kod = str_replace( '{__TOKEN_USUN_KOSZYK}', (string)Sesje::Token(), (string)$kod );
