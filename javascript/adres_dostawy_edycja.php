...
$PlikCacheJs = 'cache/js/adres_dostawy_edycja_' . $_SESSION['domyslnyJezyk']['kod'] . '.jcs';
...
if (!file_exists($PlikCacheJs) || CACHE_JS == 'nie') {
    ...
    $kod .= file_get_contents('javascript/adres_dostawy_edycja.jcs');
...
$kod = str_replace( '{__TOKEN_ADRESY_DOSTAWY}', (string)Sesje::Token(), (string)$kod );  
