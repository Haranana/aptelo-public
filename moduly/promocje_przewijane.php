...
// {{MODUL_PROMOCJE_PRZEWIJANE_PRZYCISKI;W jakiej formie wyświetlać nawigację modułu;przyciski;przyciski,strzałki}}
//
...
if ( defined('MODUL_PROMOCJE_PRZEWIJANE_PRZYCISKI') ) {
   $FormaNawigacji = MODUL_PROMOCJE_PRZEWIJANE_PRZYCISKI;
}
