...
function PowtorzPlatnosc( $parametry, $zamowienie_id ) {
    ...
    if ( $termin > (PLATNOSC_ILEASING_TERMIN_PATNOSCI *24 * 3600) ) {
       $pola = array(
    ...
    $tekst = '<form action="https://www.platformafinansowa.pl/wniosek/leasing/'.PLATNOSC_ILEASING_PARTNERID.'" method="post" name="payform" class="cmxform">
