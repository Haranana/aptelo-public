...
function PowtorzPlatnosc( $parametry, $zamowienie_id ) {
    ...
    if ( $termin > (PLATNOSC_IMOJE_TERMIN_PATNOSCI *24 * 3600) ) {
       $pola = array(
    ...
    $tekst = '<form action="https://' . ( PLATNOSC_IMOJE_SANDBOX == '1' ? 'sandbox.paywall.imoje.pl' : 'paywall.imoje.pl' ) . '/pl/payment" method="post" name="payform" class="cmxform">
