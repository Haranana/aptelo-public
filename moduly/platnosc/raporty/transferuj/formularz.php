...
function PowtorzPlatnosc( $parametry, $zamowienie_id ) {
    ...
    if ( $termin > (PLATNOSC_TRANSFERUJ_TERMIN_PATNOSCI *24 * 3600) ) {
       $pola = array(
    ...
    $tekst = '<form action="https://secure.tpay.com" accept-charset="utf-8" method="post" name="payform" class="cmxform">
