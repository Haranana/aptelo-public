  ...
  class platnosc_mbank {
    ...
    function potwierdzenie() {
        ...
        $tekst .= '<div class="WyrazamZgode">
            <label for="regulamin_mbank"><input type="checkbox" value="1" name="regulamin_mbank" id="regulamin_mbank" class="raty" />Akceptuję regulamin.<span class="check" id="check_regulamin_mbank"></span><em class="required checkreq" id="em_'.uniqid().'"></em></label><div id="error-potwierdzenie-raty"></div><br />Po potwierdzeniu zamówienia zostaniesz przekierowany do wniosku o mBank RATY,<br />gdzie będziesz mógł wnioskować o kredyt na wybrane produkty.</div>';
