...
if(!class_exists('platnosc_przelew_odroczony')) {
  class platnosc_przelew_odroczony {
    ...
    function __construct( $parametry = array() ) {
      global $zamowienie, $Tlumaczenie;
        ...
        $this->grupa           = $this->paramatery['parametry']['PLATNOSC_GRUPA_KLIENTOW'];
    ...
    function przetwarzanie( $id_zamowienia = 0 ) {
      ...
      if ( isset($_SESSION['gosc']) && $_SESSION['gosc'] == '1' ) {
          return;
      }    
