...
if(!class_exists('platnosc_transferuj')) {
  class platnosc_transferuj {
    ...
    function podsumowanie( $id_zamowienia = 0 ) {
        ...
        $kluczCRC                           = base64_encode((($id_zamowienia == 0) ? (string)$_SESSION['zamowienie_id'] : (string)$id_zamowienia));
        ...
        $parameters['opis']                 = 'Zamowienie nr: ' . (($id_zamowienia == 0) ? (int)$_SESSION['zamowienie_id'] : $id_zamowienia);
        ...
        $parameters['kraj']                 = Funkcje::kodISOKrajuDostawy( (($id_zamowienia == 0) ? $_SESSION['adresDostawy']['panstwo'] : $zamowienie->platnik['kraj']) );
        ...
        $parameters['pow_url']              = ( WLACZENIE_SSL == 'tak' ? ADRES_URL_SKLEPU_SSL : ADRES_URL_SKLEPU ) . '/platnosc_koniec.php?typ=transferuj&status=OK&zamowienie_id=' . (($id_zamowienia == 0) ? (int)$_SESSION['zamowienie_id'] : $id_zamowienia);
        $parameters['pow_url_blad']         = ( WLACZENIE_SSL == 'tak' ? ADRES_URL_SKLEPU_SSL : ADRES_URL_SKLEPU ) . '/platnosc_koniec.php?typ=transferuj&status=FAIL&zamowienie_id=' . (($id_zamowienia == 0) ? (int)$_SESSION['zamowienie_id'] : $id_zamowienia);
        ...
        $tekst .= '<form action="https://secure.tpay.com" method="post" accept-charset="utf-8" name="payform" class="cmxform">
