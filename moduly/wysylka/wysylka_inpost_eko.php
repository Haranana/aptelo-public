...
if(!class_exists('wysylka_inpost_eko')) {
  class wysylka_inpost_eko {
    ...
    function __construct( $parametry = array(), $kraj = '', $idProduktu = '', $WagaProduktu = '', $CenaProduktu = '', $WysylkiProduktu = '', $GabarytProduktu = '', $KosztWysylkiProduktu = '0', $WykluczonaDarmowaWysylka = 'nie', $ProduktWPromocji = '0' ) {
      global $zamowienie, $Tlumaczenie, $token_inpost_eko;
    ...
    public static function potwierdzenie( $koszyk = false ) {
        global $Tlumaczenie, $token_inpost_eko;
        ...
        $tekst .= '<script>
                        ...
                        $(document).ready(function() {
                            ...
                            $("#WidgetButtonPaczkomatyEko").click(function(e) {
                            e.preventDefault();
                            ...
                            myModal = new jBox("Modal", {
                              ...
                              ajax: {
                                ...
                                data: {
                                  ...
                                  adres: "' . $adres . '",
                                  modul: "paczkomaty_eko",
                                  token: "' . $token_inpost_eko .'",
                                },
                                setContent: false,
        ...
        if ( $koszyk == true ) { 
             $tekst .= '<div class="WybranyPunktMapyKoszyk" id="WybranyPaczkomatEko" style="border:0;' . ((!isset($_SESSION['rodzajDostawyKoszyk']['wysylka_inpost_eko']['opis'])) ? 'display:none' : '') . '">'.(isset($_SESSION['rodzajDostawyKoszyk']['wysylka_inpost_eko']['opis']) ? $_SESSION['rodzajDostawyKoszyk']['wysylka_inpost_eko']['opis'] : '').'</div>';
        }
        
        $tekst .= '<span class="przycisk" id="WidgetButtonPaczkomatyEko" style="font-style:normal">'.$Tlumaczenie['INPOST_WYBIERZ_PACZKOMAT'].'</span><br />';

        if ( $koszyk == false ) {
             $tekst .= '<input type="text" size="40" class="WybranyPunktMapyPaczkomaty" wysylka="wysylka_inpost_eko" id="paczkomatEko" ' . ((!isset($_SESSION['rodzajDostawy']['opis'])) ? 'style="display:none"' : '') . ' value="'.(isset($_SESSION['rodzajDostawy']['opis']) ? $_SESSION['rodzajDostawy']['opis'] : '').'" name="lokalizacjaRuch" readonly="readonly" />';
             $tekst .= '<input type="hidden" id="ShippingDestinationCodeEko" value="" name="ShippingDestinationCode" />';
             $tekst .= '<input type="hidden" id="RodzajPaczkomatEko" value="" />';
        }
        ...
        $tekst .= '<style>
                      ...
                      #paczkomatEko { width:100%; padding:10px; margin:10px 0px 0px 0px; font-size:110%; font-weight:bold;
