...
if(!class_exists('wysylka_glspickup')) {
  class wysylka_glspickup {
    ...
    function __construct( $parametry = array(), $kraj = '', $idProduktu = '', $WagaProduktu = '', $CenaProduktu = '', $WysylkiProduktu = '', $GabarytProduktu = '', $KosztWysylkiProduktu = '0', $WykluczonaDarmowaWysylka = 'nie', $ProduktWPromocji = '0' ) {
      global $zamowienie, $waga_zamowienia, $Tlumaczenie;
        ...
        $waga_zamowienia    = $this->paramatery['waga_zamowienia'];
        unset($Tlumaczenie);
    ...
    public static function potwierdzenie( $koszyk = false ) {
        global $Tlumaczenie, $waga_zamowienia;
        ...
        $tekst = '<script src="https://mapa.gls-poland.com/js/v4.0/maps_sdk.js"></script>';

        $tekst .= '<script>

                        $(document).ready(function() {

                            $("#WidgetButtonGls").click(function(e) {
                                e.preventDefault();
                                ...
                                responsiveHeight: true,
                                    ajax: {
                                        ...
                                        data: {
                                          ...
                                          adres: "' . $adres . '",
                                          modul: "gls",
                                          waga: "'. ( $waga_zamowienia == '' || $waga_zamowienia < '0.01' ? '1' : $waga_zamowienia ) .'"
                                        },
                                        setContent: false,
        ...
        if ( $koszyk == true ) { 
             $tekst .= '<div class="WybranyPunktMapyKoszyk" id="WybranyPunktGls" style="border:0;' . ((!isset($_SESSION['rodzajDostawyKoszyk']['wysylka_glspickup']['opis'])) ? 'display:none' : '') . '">'.(isset($_SESSION['rodzajDostawyKoszyk']['wysylka_glspickup']['opis']) ? $_SESSION['rodzajDostawyKoszyk']['wysylka_glspickup']['opis'] : '').'</div>';
        }
        
        $tekst .= '<span class="przycisk" id="WidgetButtonGls" style="font-style:normal">'.$Tlumaczenie['POCZTAPOLSKA_WYBIERZ_PUNKT'].'</span><br />';

        if ( $koszyk == false ) { 
             $tekst .= '<input type="text" size="40" class="WybranyPunktMapyGls" id="kioskGlsu" ' . ((!isset($_SESSION['rodzajDostawy']['opis'])) ? 'style="display:none"' : '') . ' value="'.(isset($_SESSION['rodzajDostawy']['opis']) ? $_SESSION['rodzajDostawy']['opis'] : '').'" name="lokalizacjaGls" readonly="readonly" id="wybor_glsu" />';
        ...
        $tekst .= '<style>
                      #WidokMapWysylkaGls { height:100%; width:100%; }
                      ...
                      #gls-map-more-button { display:none; }
                   </style>';
