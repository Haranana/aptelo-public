...
function jBoxWrapper(jQuery) {
  ...
  var jBox = function jBox(type, options) {
    ...
    this.options = {
      ...
      zIndex: 20000050,             // Use a high z-index, or set to 'auto' to bring to front on open
      ...
      var loadImage = function (gallery, id, show, instant) {
        ...
        jQuery('<img src="' + this.images[gallery][id].src + '" />').each(function () {
          ...
          tmpImg.onload = function () {
            ...
            imageContainer.html('<div class="jBoxOverlayImg" id="jBoxOverlayImg-' + id + '"></div><img class="jBoxImgTmp" src="' + this.images[gallery][id].src + '" alt="Foto" />');
            $('.jBoxImgTmp').on('dragstart', function(event) { event.preventDefault(); });
            $('#jBoxOverlayImg-' + id).on('click', function () { this.close({ignoreDelay: true}); }.bind(this));
          }.bind(this);
      ...
      this.showImage = function (img) {
        ...
        // Or get image data from source element
          ...
          if (this.images && this.images[gallery]) {
            ...
            // podmiana glownego zdjecia produktu
            if ( $('#DuzeFoto1').length ) {
              
                if ( gallery == 'galeria' ) {
                     this.images[gallery][0].src = $('#DuzeFoto1').attr('href');
                }
                
                if ( $('#ZdjeciaDuzeKartaProduktuJBox #jBox-image-galeria-0').length ) {
                     if ( $('#ZdjeciaDuzeKartaProduktuJBox #jBox-image-galeria-0').find('img').attr('src') != $('#DuzeFoto1').attr('href') ) { 
                          $('#ZdjeciaDuzeKartaProduktuJBox #jBox-image-galeria-0').find('img').attr('src',$('#DuzeFoto1').attr('href')); 
                     }
                }
