...
require_once dirname(__FILE__).DIRECTORY_SEPARATOR.'OLE/Root.php';
require_once dirname(__FILE__).DIRECTORY_SEPARATOR.'OLE/File.php';
    ...
    */
    ...
    public function addValidator()
    {
        if (!class_exists('Spreadsheet_Excel_Writer_Validator')) {
            include_once 'programy/Spreadsheet/Excel/Writer/Validator.php';
        }
