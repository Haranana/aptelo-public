...
$zapytanie_stronicowanie = Produkty::SqlProduktyWszystkieStronicowanie($WarunkiFiltrowania);                          
//
...
if (POKAZUJ_FILTRY_NOWOSCI == 'tak') {
    $srodek->dodaj('__FILTRY_NOWOSCI', Filtry::FiltrNowosciSelect('', 'produkty'));
} else {
...
if (POKAZUJ_FILTRY_PROMOCJE == 'tak') {
    $srodek->dodaj('__FILTRY_PROMOCJE', Filtry::FiltrPromocjeSelect('', 'produkty'));  
} else {
