...
if ($prot->wyswietlStrone) {
    ...
    if (isset($_GET['szukaj']) && $_GET['szukaj'] != '' ) {
        ...
        $warunki_szukania = " and ( m.discount_name LIKE '%".$szukana_wartosc."%' 
    ...
    if ( isset($_GET['szukaj_grupa']) && $_GET['szukaj_grupa'] != '0' ) {
        ...
        $warunki_szukania .= " and m.discount_groups_id LIKE '%,".$szukana_wartosc.",%'";
    }    
    ...
    if (isset($_GET['parametr'])) {
        ...
        if ($ile_pozycji > 0) {
            ...
            while ($info = $sql->fetch_assoc()) {
                  ...
                  $wszyscy_producenci = explode(',', (string)$info['discount_manufacturers_id']);
                  ...
                  foreach ( $wszyscy_producenci as $producent ) {
                      ...
                      if ( isset($TablicaProducenci[$producent]) ) {
                           $wyswietl .= '<span class="NazwaKatProd">' . $TablicaProducenci[$producent] . '</span> <br />';
                      }
                  ...
                  $tekst .= '<a class="TipChmurka" href="klienci/rabaty_producentow_edytuj.php'.$zmienne_do_przekazania.'"><b>Edytuj</b><img src="obrazki/edytuj.png" alt="Edytuj" /></a>';
                  $tekst .= '<a class="TipChmurka" href="klienci/rabaty_producentow_usun.php'.$zmienne_do_przekazania.'"><b>Skasuj</b><img src="obrazki/kasuj.png" alt="Skasuj" /></a>';
        ...
        <div id="caly_listing">
            ...
            <div id="wyszukaj">
                ...
                if ( Listing::wylaczFiltr(basename($_SERVER['SCRIPT_NAME'])) == true ) {
                  echo '<div id="wyszukaj_ikona"><a href="klienci/rabaty_producentow.php?filtr=nie"><img src="obrazki/reset_szukaj.png" alt="Anuluj wyszukiwanie" /></a></div>';
                }
                ?>                 
