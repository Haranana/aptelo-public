...
if ($prot->wyswietlStrone) {
    ...
    if (isset($_POST['akcja']) && $_POST['akcja'] == 'zapisz') {       
        ...
        $db->insert_query('discount_categories_manufacturers' , $pola);	
        ...
        if (isset($id_dodanej_pozycji) && $id_dodanej_pozycji > 0) {
            Funkcje::PrzekierowanieURL('rabaty_kategorii_producenta.php?id_poz='.$id_dodanej_pozycji);
        } else {
            Funkcje::PrzekierowanieURL('rabaty_kategorii_producenta.php');
        }
    }
    ...
    <div id="cont">
          ...
          <form action="klienci/rabaty_kategorii_producenta_dodaj.php" method="post" id="eForm" class="cmxform">          
          ...
          <div class="poleForm">
            ...
            <div class="pozycja_edytowana">
                ...
                <input type="hidden" name="akcja" value="zapisz" />
                    ...
                    <p>
                      <label>Kategoria do jakiej będzie przypisany rabat:</label>
                    </p>
                        ...
                        <div id="drzewo" class="WyborProducentaRabat" style="margin:0px">
                          ...
                          if (count($Prd) > 0) {
                              ...
                              for ($b = 0, $c = count($Prd); $b < $c; $b++) {
                                  echo '<tr>                                
                                          <td class="lfp">
                                              <input type="radio" value="'.$Prd[$b]['id'].'" name="id_producent" id="id_producent_' . $Prd[$b]['id'] . '" /> <label class="OpisFor" for="id_producent_' . $Prd[$b]['id'] . '">'.$Prd[$b]['text'].'</label>
                                          </td>                                
                                        </tr>';
                              }
                              echo '</table>';
                    ...
                    <div id="zakres_klient" style="display:none">
                        ...
                        <div class="TabelaSklepu">
                            ...
                            <div class="TabelaKlientow">
                                ...
                                <?php if ( count($tablica_klientow) < 2000 ) { ?>                                
