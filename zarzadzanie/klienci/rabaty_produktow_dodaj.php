...
if ($prot->wyswietlStrone) {
    ...
    if (isset($_POST['akcja']) && $_POST['akcja'] == 'zapisz') {
        ...
        $pola = array(
                ...
                array('discount_products_id',(int)$_POST["id_prod"]));
          ...
          <div class="poleForm">
            ...
            <div class="pozycja_edytowana">
                ...
                <input type="hidden" name="akcja" value="zapisz" />
                    ...
                    <p>
                      <label for="szukany">Produkt do jakiego będzie przypisany rabat:</label>
                    </p>
                    ...
                    <div class="WybieranieProduktow">
                        ...
                        <div class="GlownyListing">
                            ...
                            <div class="GlownyListingKategorieEdycja">
                                ...
                                <div id="drzewo" style="margin:0px">
                                    ...
                                    for ($w = 0, $c = count($tablica_kat); $w < $c; $w++) {
                                        ...
                                        //
                                        echo '<tr>
                                                <td class="lfp"><input type="radio" onclick="podkat_produkty(this.value)" value="'.$tablica_kat[$w]['id'].'" name="id_kat" id="id_kat_' . $tablica_kat[$w]['id'] . '" /><label class="OpisFor" for="id_kat_' . $tablica_kat[$w]['id'] . '">'.$tablica_kat[$w]['text'].(($tablica_kat[$w]['status'] == 0) ? '<div class="wylKat TipChmurka"><b>Kategoria jest nieaktywna</b></div>' : '').'</label></td>
                            ...
                            <div style="GlownyListingProduktyEdycja">  
                                ...
                                <div id="wynik_produktow_rabat_produkty" class="WynikProduktowRabatProdukty"></div> 
                          ...
                          <tr>
                              ...
                              <td>
                                  ...
                                  foreach ( $TablicaGrupKlientow as $GrupaKlienta ) {
                                      echo '<input type="checkbox" value="' . $GrupaKlienta['id'] . '" name="grupa_klientow[]" id="grupa_klientow_' . $GrupaKlienta['id'] . '" class="required" /><label class="OpisFor" for="grupa_klientow_' . $GrupaKlienta['id'] . '">' . $GrupaKlienta['text'] . '</label><br />';
                                  }              
                                  ?>
                              </td>
                          </tr>
