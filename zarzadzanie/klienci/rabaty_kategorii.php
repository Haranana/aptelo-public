...
if ($prot->wyswietlStrone) {
    ...
    if (isset($_GET['parametr'])) {
        ...
        if ($ile_pozycji > 0) {
            ...
            while ($info = $sql->fetch_assoc()) {
                  ...
                  $wszystkie_kategorie = explode(',', (string)$info['discount_categories_id']);
                  $wyswietl = '';
                  
                  foreach ( $wszystkie_kategorie as $kategoria ) {
                               
                      // jakie sa kategorie parent
                      $KatId = explode('_', (string)Kategorie::SciezkaKategoriiId($kategoria));
                      ...
                      if ( isset($TablicaKategorii[$kategoria]) ) {
                           $wyswietl .= $pelna_sciezka_kategorii . '<span class="NazwaKatProd">' . $TablicaKategorii[$kategoria]['text'] . '</span> <br />';
                      }
                  ...
                  unset($wyswietl, $wszystkie_kategorie);
                  ...
                  $tekst .= '<a class="TipChmurka" href="klienci/rabaty_kategorii_edytuj.php'.$zmienne_do_przekazania.'"><b>Edytuj</b><img src="obrazki/edytuj.png" alt="Edytuj" /></a>';
                  $tekst .= '<a class="TipChmurka" href="klienci/rabaty_kategorii_usun.php'.$zmienne_do_przekazania.'"><b>Skasuj</b><img src="obrazki/kasuj.png" alt="Skasuj" /></a>';
            ...
            //
            $db->close_query($sql);
            unset($listing_danych,$tekst,$tablica,$tablica_naglowek,$TablicaGrupyKlientow);        
    ...
    if (!isset($_GET['parametr'])) { 
        ...
        <div id="caly_listing">
            ...
            <div id="naglowek_cont">Rabaty dla kategorii</div>  

            <div id="wyszukaj">
                <form action="klienci/rabaty_kategorii.php" method="post" id="klienciForm" class="cmxform">
                ...
                if ( Listing::wylaczFiltr(basename($_SERVER['SCRIPT_NAME'])) == true ) {
                  echo '<div id="wyszukaj_ikona"><a href="klienci/rabaty_kategorii.php?filtr=nie"><img src="obrazki/reset_szukaj.png" alt="Anuluj wyszukiwanie" /></a></div>';
                }
                ?>                          
            ...
            <div id="sortowanie">
                ...
                <a id="sort_a1" class="sortowanie" href="klienci/rabaty_kategorii.php?sort=sort_a1">nazwa malejąco</a>
                <a id="sort_a2" class="sortowanie" href="klienci/rabaty_kategorii.php?sort=sort_a2">nazwa rosnąco</a>
                <a id="sort_a3" class="sortowanie" href="klienci/rabaty_kategorii.php?sort=sort_a3">rabat malejąco</a>
                <a id="sort_a4" class="sortowanie" href="klienci/rabaty_kategorii.php?sort=sort_a4">rabat rosnąco</a>
                <a id="sort_a7" class="sortowanie" href="klienci/rabaty_kategorii.php?sort=sort_a7">nazwiska klientów malejąco</a>
                <a id="sort_a8" class="sortowanie" href="klienci/rabaty_kategorii.php?sort=sort_a8">nazwiska klientów rosnąco</a>             
            ...
            <div id="PozycjeIkon">
                <div>
                    <a class="dodaj" href="klienci/rabaty_kategorii_dodaj.php">dodaj nową pozycję</a>
                </div>            
            </div>
            ...
            <?php Listing::pokazAjax('klienci/rabaty_kategorii.php', $zapytanie, $ile_licznika, $ile_pozycji, 'discount_id'); ?>
            </script>              
