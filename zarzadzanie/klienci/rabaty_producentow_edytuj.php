...
if ($prot->wyswietlStrone) {
    ...
    <div id="cont">
          ...
          <div class="poleForm">
            ...
            $zapytanie = "select * from discount_manufacturers where discount_id = '" . (int)$_GET['id_poz'] . "'";
                    ...
                    <div class="info_content">
                        ...
                        <div class="WybieranieKategoriiProducenta">
                            ...
                            <div id="drzewo" style="margin:0px;">
                              ...
                              <?php
                              //
                              $ProducenciRabaty = explode(',', (string)$info['discount_manufacturers_id']);
                              //
                              ...
                              if (count($Prd) > 0) {
                                  ...
                                  for ($b = 0, $c = count($Prd); $b < $c; $b++) {
                                      //
                                      $check = '';
                                      if ( in_array((string)$Prd[$b]['id'], $ProducenciRabaty) ) {
                                          $check = 'checked="checked"';
                                      }
                                      //                              
                                      echo '<tr>                                
                                              <td class="lfp">
                                                  <input type="checkbox" value="'.$Prd[$b]['id'].'" name="id_producent[]" id="id_producent_' . $Prd[$b]['id'] . '" ' . $check . ' /> <label class="OpisFor" for="id_producent_' . $Prd[$b]['id'] . '">'.$Prd[$b]['text'].'</label>
                                              </td>                                
                                            </tr>';
                                  }
                                  echo '</table>';
