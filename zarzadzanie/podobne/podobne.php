...
if ($prot->wyswietlStrone) {
    ...
    $zapytanie = "SELECT p.products_id, 
              ...
              RIGHT JOIN products_options_products s ON p.products_id = s.pop_products_id_master " . $warunki_szukania . ' GROUP BY p.products_id '; 
    ...
    if (isset($_GET['parametr'])) {
        ...
        if ($ile_pozycji > 0) {
            ...
            while ($info = $sql->fetch_assoc()) {
                  ...
                  $tekst .= '<a class="TipChmurka" href="podobne/podobne_edytuj.php'.$zmienne_do_przekazania.'"><b>Edytuj</b><img src="obrazki/edytuj.png" alt="Edytuj" /></a>'; 
                  $tekst .= '<a class="TipChmurka" href="podobne/podobne_usun.php'.$zmienne_do_przekazania.'"><b>Skasuj</b><img src="obrazki/kasuj.png" alt="Skasuj" /></a>';
        ...
        <div id="caly_listing">
            ...
            <div id="wyszukaj">
                ...
                if ( Listing::wylaczFiltr(basename($_SERVER['SCRIPT_NAME'])) == true ) {
                  echo '<div id="wyszukaj_ikona"><a href="podobne/podobne.php?filtr=nie"><img src="obrazki/reset_szukaj.png" alt="Anuluj wyszukiwanie" /></a></div>';
                }
                ?>            
            ...
            <div id="sortowanie">
                ...
                <a id="sort_a1" class="sortowanie" href="podobne/podobne.php?sort=sort_a1">brak</a>
                <a id="sort_a17" class="sortowanie" href="podobne/podobne.php?sort=sort_a17">nazwy rosnąco</a>
                <a id="sort_a2" class="sortowanie" href="podobne/podobne.php?sort=sort_a2">nazwy malejąco</a>
                <a id="sort_a7" class="sortowanie" href="podobne/podobne.php?sort=sort_a7">nr katalogowy rosnąco</a>
                <a id="sort_a8" class="sortowanie" href="podobne/podobne.php?sort=sort_a8">nr katalogowy malejąco</a> 
                <a id="sort_a9" class="sortowanie" href="podobne/podobne.php?sort=sort_a9">cena rosnąco</a>
                <a id="sort_a10" class="sortowanie" href="podobne/podobne.php?sort=sort_a10">cena malejąco</a>             
                <a id="sort_a3" class="sortowanie" href="podobne/podobne.php?sort=sort_a3">aktywne</a>
                <a id="sort_a4" class="sortowanie" href="podobne/podobne.php?sort=sort_a4">nieaktywne</a> 
                <a id="sort_a13" class="sortowanie" href="podobne/podobne.php?sort=sort_a13">ID malejąco</a>
                <a id="sort_a14" class="sortowanie" href="podobne/podobne.php?sort=sort_a14">ID rosnąco</a>
                <a id="sort_a15" class="sortowanie" href="podobne/podobne.php?sort=sort_a15">sortowanie malejąco</a>
                <a id="sort_a16" class="sortowanie" href="podobne/podobne.php?sort=sort_a16">sortowanie rosnąco</a>
                    ...
                    <div class="OknoKategoriiKontener">
                        ...
                        for ($w = 0, $c = count($tablica_kat); $w < $c; $w++) {
                            ...
                            echo '<tr>
                                    ...
                                    <td class="rgp" '.(($podkategorie) ? 'id="img_'.$tablica_kat[$w]['id'].'"' : '').'>'.(($podkategorie) ? '<img src="obrazki/rozwin.png" alt="Rozwiń" onclick="podkat(\''.$tablica_kat[$w]['id'].'\',\'\',\'\',\'\',\'podobne\')" />' : '').'</td>
                                  </tr>
            ...
            <?php Listing::pokazAjax('podobne/podobne.php', $zapytanie, $ile_licznika, $ile_pozycji, 'products_id', ILOSC_WYNIKOW_NA_STRONIE, ADMIN_DOMYSLNE_SORTOWANIE); ?>
            </script>              
