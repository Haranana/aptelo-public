...
if ($prot->wyswietlStrone) {
    ...
    if (isset($_POST['akcja']) && $_POST['akcja'] == 'zapisz') {
        //			
        $db->delete_query('offers_products' , " id_products_offers = '".(int)$_POST["id"]."'");  
        //
        Funkcje::PrzekierowanieURL('oferty_produkty.php?oferta_id='.(int)$_POST["oferta_id"]);
    }
    ...
    <div id="cont">
          ...
          <form action="oferty/oferty_produkty_usun.php" method="post" class="cmxform">          
