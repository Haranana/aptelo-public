...
if ($prot->wyswietlStrone) {
    ...
    if (isset($_POST['akcja']) && $_POST['akcja'] == 'zapisz') {
        //			
        $db->delete_query('offers' , " offers_id = '".(int)$_POST["id"]."'");  
        $db->delete_query('offers_products' , " offers_id = '".(int)$_POST["id"]."'");
        //
    ...
    <div id="cont">
          ...
          <form action="oferty/oferty_usun.php" method="post" class="cmxform">          
