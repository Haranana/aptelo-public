...
if ($prot->wyswietlStrone) {
    ...
    if (isset($_POST['akcja']) && $_POST['akcja'] == 'zapisz') {
        ...
        $ilosc_produktow = $filtr->process(( !empty($_POST['ilosc']) ? $_POST['ilosc'] : '0' ));
        ...
        if (isset($_POST['porownywarki_wykluczony'])) {
            $pola[] = array('export_status_exclude','1');  
        }
        if (isset($_POST['porownywarki_ceneo_kup_teraz'])) {
        ...
        if (isset($_POST['darmowa_dostawa_wykluczona'])) {
            $pola[] = array('free_shipping_excluded',$filtr->process($_POST['darmowa_dostawa_wykluczona']));               
        }             
        ...
        $pola = array(
                ...
                array('products_name_allegro',((isset($_POST['nazwa_allegro'])) ? $filtr->process($_POST['nazwa_allegro']) : '')),
                array('products_image_allegro',((isset($_POST['zdjecie_allegro'])) ? $filtr->process($_POST['zdjecie_allegro']) : '')),
                array('products_weight_allegro',((isset($_POST['waga_allegro'])) ? (float)$_POST['waga_allegro'] : '')),
                array('products_cat_id_allegro',((isset($_POST['kategoria_allegro'])) ? (int)$_POST['kategoria_allegro'] : '')),
                array('products_price_allegro',((isset($_POST['cena_brutto_allegro'])) ? (float)$_POST['cena_brutto_allegro'] : '')));        
        ...
        if (CECHY_MAGAZYN == 'tak') {
            ...
            if ((int)$db->ile_rekordow($sqls) > 0) {
                ...
                $db->close_query($sqls);
                //
                $pola = array(array('products_quantity',(float)$ogolna_ilosc));
        ...
        if (isset($id_dodanej_pozycji) && $id_dodanej_pozycji > 0) {
            ...
            if ( isset($_POST['powrot']) && (int)$_POST['powrot'] == 1 ) {
                ...
                if ( isset($_POST['id_zestawu']) ) {
                     Funkcje::PrzekierowanieURL('zestawy_produktow.php?id_poz=' . (int)$id_dodanej_pozycji);
                  } else {
                     Funkcje::PrzekierowanieURL('produkty.php?id_poz=' . (int)$id_dodanej_pozycji);
                }
                //
            }                
    ...
    <div id="cont">
          ...
          <form action="produkty/produkty_dodaj.php" method="post" id="poForm" class="cmxform" onsubmit="return sprFormularz()" enctype="multipart/form-data">  
          
          <input type="hidden" name="dodawanie" id="dodawanie" value="tak" />
          
          <div class="poleForm">
            <div class="naglowek">Dodawanie nowego produktu <b id="NazwaProduktu"></b></div>
            ...
            <div class="przyciski_dolne">
              ...
              <input type="hidden" name="zakladka" id="zakladka" value="0" />
