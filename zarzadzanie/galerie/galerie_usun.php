...
if ($prot->wyswietlStrone) {
    ...
    if (isset($_POST['akcja']) && $_POST['akcja'] == 'zapisz') {
        //			
        $db->delete_query('gallery' , " id_gallery = '".(int)$_POST["id"]."'");  
        $db->delete_query('gallery_description' , " id_gallery = '".(int)$_POST["id"]."'");
        $db->delete_query('gallery_image' , " id_gallery = '".(int)$_POST["id"]."'");
        
        // funkcja usuwa rowniez wpis w gornym i dolnym menu i stopkach
        Funkcje::UsuwanieWygladu('galeria',(int)$_POST["id"]);
    ...
    <div id="cont">
          ...
          <div class="poleForm">
            ...
            $zapytanie = "select * from gallery where id_gallery = '" . (int)$_GET['id_poz'] . "'";
