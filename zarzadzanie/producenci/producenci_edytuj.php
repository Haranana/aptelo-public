...
if ($prot->wyswietlStrone) {
    ...
    if (isset($_POST['akcja']) && $_POST['akcja'] == 'zapisz') {
        ...
        // kasuje rekordy w tablicy
        $db->delete_query('location', " manufacturers_id = '".$id_producent."'");           
    ...
    <div id="cont">
          ...
          <div class="poleForm">
            ...
            $zapytanie = "select distinct * from manufacturers m where m.manufacturers_id = '".(int)$_GET['id_poz']."'";
            ...
            if ((int)$db->ile_rekordow($sql) > 0) {
                ...
                <div class="pozycja_edytowana">    
                    ...
                    <p>
                      ...
                      <input type="text" name="zdjecie" size="95" value="<?php echo $info['manufacturers_image']; ?>" class="obrazek" ondblclick="openFileBrowser('foto','','<?php echo KATALOG_ZDJEC; ?>')" id="foto" autocomplete="off" />                 
                    ...
                    <p>
                      ...
                      <input type="text" name="nazwa_pelna" size="80" value="<?php echo Funkcje::formatujTekstInput($info['manufacturers_full_name']); ?>" id="nazwa_pelna" />
                    </p>        
                    
                    <p>
                      <label for="producent_ulica">Ulica:</label>
                      <input type="text" name="producent_ulica" id="producent_ulica" size="40" value="<?php echo Funkcje::formatujTekstInput($info['manufacturers_street']); ?>" />
                    </p>     

                    <p>
                      <label for="producent_kod_pocztowy">Kod pocztowy:</label>
                      <input type="text" name="producent_kod_pocztowy" id="producent_kod_pocztowy" size="10" value="<?php echo $info['manufacturers_post_code']; ?>" />
                    </p>  
                    
                    <p>
                      <label for="producent_miasto">Miasto:</label>
                      <input type="text" name="producent_miasto" id="producent_miasto" size="20" value="<?php echo $info['manufacturers_city']; ?>" />
                    </p>  
                    ...
                    <p>
                      ...
                      <?php foreach ( Funkcje::KrajeIso() as $nazwa => $kod ) { ?>
                          <option value="<?php echo $kod; ?>" <?php echo (($info['manufacturers_country'] == $kod) ? 'selected="selected"' : ''); ?>><?php echo $nazwa; ?></option>                      
                      <?php } ?>
                      </select>
                    </p>
                    ...
                    <p>
                      ...
                      <input type="text" name="producent_email" size="40" id="producent_email" value="<?php echo $info['manufacturers_email']; ?>" />
                    </p> 
                    
                    <p>
                      <label for="producent_telefon">Numer telefonu:</label>
                      <input type="text" name="producent_telefon" size="20" id="producent_telefon" value="<?php echo $info['manufacturers_phone']; ?>" />
                    </p> 
                    
                    <div style="padding:15px 10px 15px 25px">
                        <input type="checkbox" name="importer_producent" id="importer_producent_tak" <?php echo (((int)$info['importer_unchanged'] == 0) ? 'checked="checked"' : ''); ?> value="1" /> <label class="OpisFor" for="importer_producent_tak">dane importera / pełnomocnika takie same jak producenta</label>
                    </div>       

                    <div <?php echo (((int)$info['importer_unchanged'] == 0) ? 'style="display:none"' : ''); ?> class="DaneImportera">
                        ...
                        <p>
                          ...
                          <input type="text" name="importer_nazwa" size="80" id="importer_nazwa" value="<?php echo Funkcje::formatujTekstInput($info['importer_name']); ?>" />
                        </p>                          
                        
                        <p>
                          <label for="importer_ulica">Ulica:</label>
                          <input type="text" name="importer_ulica" size="40" id="importer_ulica" value="<?php echo Funkcje::formatujTekstInput($info['importer_street']); ?>" />
                        </p>     

                        <p>
                          <label for="importer_kod_pocztowy">Kod pocztowy:</label>
                          <input type="text" name="importer_kod_pocztowy" size="10" id="importer_kod_pocztowy" value="<?php echo $info['importer_post_code']; ?>" />
                        </p>  
                        
                        <p>
                          <label for="importer_miasto">Miasto:</label>
                          <input type="text" name="importer_miasto" size="20" id="importer_miasto" value="<?php echo $info['importer_city']; ?>" />
                        </p>  
                        ...
                        <p>
                          ...
                          <?php foreach ( Funkcje::KrajeIso() as $nazwa => $kod ) { ?>
                              <option value="<?php echo $kod; ?>" <?php echo (($info['importer_country'] == $kod) ? 'selected="selected"' : ''); ?>><?php echo $nazwa; ?></option>                     
                          <?php } ?>
                          </select>
                        </p>
                        ...
                        <p>
                          ...
                          <input type="text" name="importer_email" size="40" id="importer_email" value="<?php echo $info['importer_email']; ?>" />
                        </p> 
                        
                        <p>
                          <label for="importer_telefon">Numer telefonu:</label>
                          <input type="text" name="importer_telefon" size="20" id="importer_telefon" value="<?php echo $info['importer_phone']; ?>" />
                        </p> 
                    ...
                    <div class="info_tab_content">
                        ...
                        for ($w = 0, $c = count($ile_jezykow); $w < $c; $w++) {
                            ...
                            $zapytanie_jezyk = "select distinct * from manufacturers_info where manufacturers_id = '".(int)$_GET['id_poz']."' and languages_id = '" .$ile_jezykow[$w]['id']."'";
                            $sqls = $db->open_query($zapytanie_jezyk);
                            $producent = $sqls->fetch_assoc();   
                            if ( count((array)$producent) > 0 ) {
                              $id_producenta = $producent['manufacturers_id'];
                            }
                            ?>
                            ...
                            <div id="info_tab_id_<?php echo $w; ?>" style="display:none;">
                                ...
                                <p>
                                  ...
                                  <input type="text" name="url_<?php echo $w; ?>" size="120" value="<?php echo (isset($producent['manufacturers_url']) ? $producent['manufacturers_url'] : ''); ?>" id="url_<?php echo $w; ?>" />
                                </p>                         
                            
                                <p>
                                  <label for="tytul_<?php echo $w; ?>">Meta Tagi - Tytuł:</label>
                                  <input type="text" name="tytul_<?php echo $w; ?>" size="120" onkeyup="licznik_znakow_meta(this,'iloscZnakowNazwa_<?php echo $w; ?>')" value="<?php echo (isset($producent['manufacturers_meta_title_tag']) ? $producent['manufacturers_meta_title_tag'] : ''); ?>" id="tytul_<?php echo $w; ?>" />
                                </p> 
                                
                                <p class="LicznikMeta">
                                  <label></label>
                                  Ilość wpisanych znaków: <span class="iloscZnakow" id="iloscZnakowNazwa_<?php echo $w; ?>"><?php echo (isset($producent['manufacturers_meta_title_tag']) ? strlen(mb_convert_encoding((string)$producent['manufacturers_meta_title_tag'], 'ISO-8859-1', 'UTF-8')) : '0'); ?></span>
                                ...
                                <p>
                                  ...
                                  <input type="text" name="opis_<?php echo $w; ?>" size="120" onkeyup="licznik_znakow_meta(this,'iloscZnakowOpis_<?php echo $w; ?>')"  value="<?php echo (isset($producent['manufacturers_meta_desc_tag']) ? $producent['manufacturers_meta_desc_tag'] : ''); ?>" id="opis_<?php echo $w; ?>" />
                                </p> 

                                <p class="LicznikMeta">
                                  <label></label>
                                  Ilość wpisanych znaków: <span class="iloscZnakow" id="iloscZnakowOpis_<?php echo $w; ?>"><?php echo (isset($producent['manufacturers_meta_desc_tag']) ? strlen(mb_convert_encoding((string)$producent['manufacturers_meta_desc_tag'], 'ISO-8859-1', 'UTF-8')) : '0'); ?></span>
                                ...
                                <p>
                                  ...
                                  <input type="text" name="slowa_<?php echo $w; ?>" size="120" onkeyup="licznik_znakow_meta(this,'iloscZnakowSlowa_<?php echo $w; ?>')" value="<?php echo (isset($producent['manufacturers_meta_keywords_tag']) ? $producent['manufacturers_meta_keywords_tag'] : ''); ?>" id="slowa_<?php echo $w; ?>" />
                                </p>  

                                <p class="LicznikMeta">
                                  <label></label>
                                  Ilość wpisanych znaków: <span class="iloscZnakow" id="iloscZnakowSlowa_<?php echo $w; ?>"><?php echo (isset($producent['manufacturers_meta_keywords_tag']) ? strlen(mb_convert_encoding((string)$producent['manufacturers_meta_keywords_tag'], 'ISO-8859-1', 'UTF-8')) : '0'); ?></span>
                                ...
                                <p>
                                  ...
                                  <textarea cols="50" rows="20" id="edytor_<?php echo $w; ?>" name="edytor_<?php echo $w; ?>"><?php echo (isset($producent['manufacturers_description']) ? $producent['manufacturers_description'] : ''); ?></textarea>
                                </p> 
                                ...
                                <p>
                                  ...
                                  <textarea cols="50" rows="20" id="edytor_dol_<?php echo $w; ?>" name="edytor_dol_<?php echo $w; ?>"><?php echo (isset($producent['manufacturers_description_bottom']) ? $producent['manufacturers_description_bottom'] : ''); ?></textarea>
                                </p>
                                ...
                                <p>
                                  ...
                                  <input type="text" name="info_nazwa_<?php echo $w; ?>" size="80" value="<?php echo (isset($producent['manufacturers_info_name']) ? $producent['manufacturers_info_name'] : ''); ?>" id="info_nazwa_<?php echo $w; ?>" />
                                </p>  
                                ...
                                <p style="padding-top:5px">
                                  <textarea cols="50" rows="30" id="edytor_info_<?php echo $w; ?>" name="edytor_info_<?php echo $w; ?>"><?php echo (isset($producent['manufacturers_info_text']) ? $producent['manufacturers_info_text'] : ''); ?></textarea>                                  
                                </p>
                    ...
                    <?php
                    $zapytanie_tmp = "select distinct urlf from location where manufacturers_id = '".$id_producenta."' and url_type = 'producent'";
                    $sqls = $db->open_query($zapytanie_tmp);
                    $seo = $sqls->fetch_assoc();
                    //
                    if ((int)$db->ile_rekordow($sqls) > 0) {
                        $producent_old_url = $seo['urlf'];
                    } else {
                        $producent_old_url = '';
                    }
                    ?>
                    ...
                    <p>
                      ...
                      <input type="text" name="url_stary" id="url_stary" size="110" value="<?php echo $producent_old_url; ?>" /><em class="TipIkona"><b>Adres jest wykorzystywany tylko w przypadku jeżeli sklep funkcjonował wcześniej na innym oprogramowaniu</b></em>
                    </p>            
