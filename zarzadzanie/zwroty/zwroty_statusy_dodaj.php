...
if ($prot->wyswietlStrone) {
    ...
    if (isset($_POST['akcja']) && $_POST['akcja'] == 'zapisz') {
        ...
        //	
        $db->insert_query('return_status' , $pola);	
        ...
        for ($w = 0, $c = count($ile_jezykow); $w < $c; $w++) {
            ...
            //
            $pola = array(
                    array('return_status_id',$id_dodanej_pozycji),
        ...
        if (isset($id_dodanej_pozycji) && $id_dodanej_pozycji > 0) {
            Funkcje::PrzekierowanieURL('zwroty_statusy.php?id_poz='.$id_dodanej_pozycji);
        } else {
    ...
    <div id="cont">
          ...
          <form action="zwroty/zwroty_statusy_dodaj.php" method="post" id="zwrotForm" class="cmxform">          
