...
if ($prot->wyswietlStrone) {
    ...
    if ( isset($_GET['szukaj_data_rozpoczecia_od']) && $_GET['szukaj_data_rozpoczecia_od'] != '' ) {
        ...
        $warunki_szukania .= " and p.star_date >= '".$szukana_wartosc."' and p.star_date != '0000-00-00'";
    }
    ...
    if ( isset($_GET['szukaj_data_zakonczenia_od']) && $_GET['szukaj_data_zakonczenia_od'] != '' ) {
        ...
        $warunki_szukania .= " and p.star_date_end >= '".$szukana_wartosc."' and p.star_date_end != '0000-00-00'";
    }
    ...
    if (isset($_GET['parametr'])) {
        ...
        if ($ile_pozycji > 0) {
            ...
            while ($info = $sql->fetch_assoc()) {
                  ...
                  $tablica[] = array(((Funkcje::czyNiePuste($info['star_date'])) ? date('d-m-Y',FunkcjeWlasnePHP::my_strtotime($info['star_date'])) : '-'),'center','white-space:nowrap'); 

                  $tablica[] = array(((Funkcje::czyNiePuste($info['star_date_end'])) ? date('d-m-Y',FunkcjeWlasnePHP::my_strtotime($info['star_date_end'])) : '-'),'center','white-space:nowrap');                     
                  ...
                  $tekst .= '<a class="TipChmurka" href="nasz_hit/nasz_hit_edytuj.php'.$zmienne_do_przekazania.'"><b>Edytuj</b><img src="obrazki/edytuj.png" alt="Edytuj" /></a>'; 
                  $tekst .= '<a class="TipChmurka" href="nasz_hit/nasz_hit_usun.php'.$zmienne_do_przekazania.'"><b>Skasuj</b><img src="obrazki/kasuj.png" alt="Skasuj" /></a>';
        ...
        <div id="caly_listing">
            ...
            <div id="wyszukaj">
                ...
                if ( Listing::wylaczFiltr(basename($_SERVER['SCRIPT_NAME'])) == true ) {
                  echo '<div id="wyszukaj_ikona"><a href="nasz_hit/nasz_hit.php?filtr=nie"><img src="obrazki/reset_szukaj.png" alt="Anuluj wyszukiwanie" /></a></div>';
                }
                ?>           
            ...
            <div id="sortowanie">
                ...
                <a id="sort_a20" class="sortowanie" href="nasz_hit/nasz_hit.php?sort=sort_a20">aktywne</a>
                <a id="sort_a21" class="sortowanie" href="nasz_hit/nasz_hit.php?sort=sort_a21">nieaktywne</a>                
                ...
                <a id="sort_a18" class="sortowanie" href="nasz_hit/nasz_hit.php?sort=sort_a18">sortowanie malejąco</a>
                <a id="sort_a19" class="sortowanie" href="nasz_hit/nasz_hit.php?sort=sort_a19">sortowanie rosnąco</a>                      
                    ...
                    <div class="OknoKategoriiKontener">
                        ...
                        for ($w = 0, $c = count($tablica_kat); $w < $c; $w++) {
                            ...
                            echo '<tr>
                                    ...
                                    <td class="rgp" '.(($podkategorie) ? 'id="img_'.$tablica_kat[$w]['id'].'"' : '').'>'.(($podkategorie) ? '<img src="obrazki/rozwin.png" alt="Rozwiń" onclick="podkat(\''.$tablica_kat[$w]['id'].'\',\'\',\'\',\'\',\'nasz_hit\')" />' : '').'</td>
                                  </tr>
            ...
            <?php Listing::pokazAjax('nasz_hit/nasz_hit.php', $zapytanie, $ile_licznika, $ile_pozycji, 'products_id', ILOSC_WYNIKOW_NA_STRONIE, ADMIN_DOMYSLNE_SORTOWANIE); ?>
            </script>              
