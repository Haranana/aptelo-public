...
if ($prot->wyswietlStrone) {
    ...
    if (isset($_POST['akcja']) && $_POST['akcja'] == 'zapisz') {
        ...
        if ( (isset($_POST['cena_poprzednia']) && (float)$_POST['cena_poprzednia'] > 0) ) {
              //
        ...
        Funkcje::PrzekierowanieURL('wyprzedaz.php?id_poz='.(int)$id_dodawanej_pozycji);
    }
    ...
    <div id="cont">
          ...
          <form action="wyprzedaz/wyprzedaz_dodaj.php" method="post" id="poForm" class="cmxform">          
          ...
          <div class="poleForm">
            ...
            <div class="pozycja_edytowana">
                ...
                <script>
                function wyprzedaz(id) {
                  $('#formi').slideDown('fast');
                  $('#ButZapis').css('display','inline-block');
                  //
                  $('#daneWyprzedaz').html('<img style="margin-left:10px" src="obrazki/_loader_small.gif">');
                  //
                  $.get("ajax/wyprzedaz.php", 
                      { id: id, tok: $('#tok').val() },
                      function(data) { 
                          $('#daneWyprzedaz').hide();
                          $('#daneWyprzedaz').html(data);                                                           
                          $('#daneWyprzedaz').slideDown();
                          //
                          pokazChmurki();
                          //
                  });                   
                ...
                <div class="GlownyListing">
                    ...
                    <div class="GlownyListingKategorieEdycja">  
                        ...
                        Wyszukaj produkt lub wybierz kategorię z której chcesz wybrać produkt do utworzenia wyprzedaży
                        </p>
                    ...
                    <div style="GlownyListingProduktyEdycja"> 
                        ...
                        <div id="wynik_produktow_wyprzedaz" class="WynikProduktowWyprzedaz" style="display:none"></div> 
                        
                        <div class="info_content" style="padding-left:5px">                                 
                        
                            <div id="formi" style="display:none">
                            
                                <span class="WynikNaglowekDodanie">Ustaw parametry dodawanej wyprzedaży</span>
                                
                                <div id="daneWyprzedaz"></div>
            ...
            <div class="przyciski_dolne">
              ...
              <button type="button" class="przyciskNon" onclick="cofnij('wyprzedaz','<?php echo Funkcje::Zwroc_Wybrane_Get(array('id_poz')); ?>','wyprzedaz');">Powrót</button>   
            </div> 
