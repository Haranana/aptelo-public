...
if ($prot->wyswietlStrone) {
    ...
    $warunki_szukania .= ' and p.sale_status = "1" and p.specials_status = "0" ';
    ...
    if (isset($_GET['parametr'])) {
        ...
        if ($ile_pozycji > 0) {
            ...
            while ($info = $sql->fetch_assoc()) {
                  ...
                  $tablica[] = array( (((float)$info['products_old_price'] == 0) ? '' : '<div class="cena_promocyjna">' . $waluty->FormatujCene($info['products_old_price'], false, $info['products_currencies_id']) . '</div>') . 
                  ...
                  $tekst .= '<a class="TipChmurka" href="wyprzedaz/wyprzedaz_edytuj.php'.$zmienne_do_przekazania.'"><b>Edytuj</b><img src="obrazki/edytuj.png" alt="Edytuj" /></a>'; 
                  $tekst .= '<a class="TipChmurka" href="wyprzedaz/wyprzedaz_usun.php'.$zmienne_do_przekazania.'"><b>Skasuj</b><img src="obrazki/kasuj.png" alt="Skasuj" /></a>'; 
    ...
    if (!isset($_GET['parametr'])) { 
        ...
        <div id="caly_listing">
            ...
            <div id="naglowek_cont">Wyprzedaż</div>
            
            <div id="wyszukaj">
                <form action="wyprzedaz/wyprzedaz.php" method="post" id="poForm" class="cmxform"> 
                ...
                if ( Listing::wylaczFiltr(basename($_SERVER['SCRIPT_NAME'])) == true ) {
                  echo '<div id="wyszukaj_ikona"><a href="wyprzedaz/wyprzedaz.php?filtr=nie"><img src="obrazki/reset_szukaj.png" alt="Anuluj wyszukiwanie" /></a></div>';
                }
                ?>            
            ...
            <form action="wyprzedaz/wyprzedaz_akcja.php" method="post" class="cmxform">
            
            <div id="sortowanie">
            
                <span>Sortowanie: </span>
                
                <a id="sort_a1" class="sortowanie" href="wyprzedaz/wyprzedaz.php?sort=sort_a1">brak</a>
                <a id="sort_a15" class="sortowanie" href="wyprzedaz/wyprzedaz.php?sort=sort_a15">nazwy rosnąco</a>
                <a id="sort_a2" class="sortowanie" href="wyprzedaz/wyprzedaz.php?sort=sort_a2">nazwy malejąco</a>
                <a id="sort_a7" class="sortowanie" href="wyprzedaz/wyprzedaz.php?sort=sort_a7">nr katalogowy rosnąco</a>
                <a id="sort_a8" class="sortowanie" href="wyprzedaz/wyprzedaz.php?sort=sort_a8">nr katalogowy malejąco</a> 
                <a id="sort_a9" class="sortowanie" href="wyprzedaz/wyprzedaz.php?sort=sort_a9">cena rosnąco</a>
                <a id="sort_a10" class="sortowanie" href="wyprzedaz/wyprzedaz.php?sort=sort_a10">cena malejąco</a>             
                <a id="sort_a3" class="sortowanie" href="wyprzedaz/wyprzedaz.php?sort=sort_a3">aktywne</a>
                <a id="sort_a4" class="sortowanie" href="wyprzedaz/wyprzedaz.php?sort=sort_a4">nieaktywne</a>               
                <a id="sort_a11" class="sortowanie" href="wyprzedaz/wyprzedaz.php?sort=sort_a11">ID malejąco</a>
                <a id="sort_a12" class="sortowanie" href="wyprzedaz/wyprzedaz.php?sort=sort_a12">ID rosnąco</a>  
                <a id="sort_a13" class="sortowanie" href="wyprzedaz/wyprzedaz.php?sort=sort_a13">sortowanie malejąco</a>
                <a id="sort_a14" class="sortowanie" href="wyprzedaz/wyprzedaz.php?sort=sort_a14">sortowanie rosnąco</a>                
            ...
            <?php
            // przycisk dodania nowej wyprzedazy
            ?>
            <div id="PozycjeIkon">
                <div>
                    <a class="dodaj" href="wyprzedaz/wyprzedaz_dodaj.php">dodaj nową wyprzedaż</a>
                </div>  
            </div> 
                ...
                <div class="GlownyListingKategorie">
                    ...
                    <div class="OknoKategoriiKontener">
                        ...
                        for ($w = 0, $c = count($tablica_kat); $w < $c; $w++) {
                            ...
                            //
                            echo '<tr>
                                    <td class="lfp"><a href="wyprzedaz/wyprzedaz.php?kategoria_id='.$tablica_kat[$w]['id'].'" '.$style.'>'.$tablica_kat[$w]['text'].'</a></td>
                                    <td class="rgp" '.(($podkategorie) ? 'id="img_'.$tablica_kat[$w]['id'].'"' : '').'>'.(($podkategorie) ? '<img src="obrazki/rozwin.png" alt="Rozwiń" onclick="podkat(\''.$tablica_kat[$w]['id'].'\',\'\',\'\',\'\',\'wyprzedaz\')" />' : '').'</td>
                                  </tr>
                        ...
                        if (isset($_GET['kategoria_id']) && (int)$_GET['kategoria_id'] > 0) {
                            ...
                            if (count($cSciezka) > 1) {
                                ...
                                <script>           
                                podkat('<?php echo $analiza_sciezki; ?>', '<?php echo $cSciezka[count($cSciezka)-1]; ?>','','','wyprzedaz');
                                </script>
                    ...
                    <div id="akcja" class="AkcjaOdstep">
                        ...
                        <div id="akc">
                            ...
                            <select name="akcja_dolna" id="akcja_dolna">
                                ...
                                <option value="1">usuń wyprzedaż z zaznaczonych produktów</option>
                            </select>
                        </div>
                        <div style="clear:both;"></div>
                    </div>                          
            ...
            <?php Listing::pokazAjax('wyprzedaz/wyprzedaz.php', $zapytanie, $ile_licznika, $ile_pozycji, 'products_id', ILOSC_WYNIKOW_NA_STRONIE, ADMIN_DOMYSLNE_SORTOWANIE); ?>
            </script>            
