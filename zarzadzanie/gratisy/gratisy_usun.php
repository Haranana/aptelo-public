...
if ($prot->wyswietlStrone) {
    ...
    if (isset($_POST['akcja']) && $_POST['akcja'] == 'zapisz') {
        ...
        $id_gratisu = (int)$_POST['id'];
    
        // kasuje rekordy w tablicy
        $db->delete_query('products_gift' , " id_gift = '".$id_gratisu."'");     
    ...
    <div id="cont">
          ...
          <form action="gratisy/gratisy_usun.php" method="post" class="cmxform">          
          ...
          <div class="poleForm">
            ...
            $zapytanie = "select * from products_gift where id_gift = '" . (int)$_GET['id_poz'] . "'";
