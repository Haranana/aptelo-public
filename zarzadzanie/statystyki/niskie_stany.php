...
if ( isset($_GET['tylko_alarm']) ) {
     //
     unset($_SESSION['filtry']['niskie_stany.php']);
     $_SESSION['filtry']['niskie_stany.php']['alarm'] = '1';
     //
     Funkcje::PrzekierowanieURL('niskie_stany.php');
}
            ...
            <div class="naglowek">Raport produktów z niskim stanem magazynowym</div>
                ...
                <div class="pozycja_edytowana">  
                    ...
                    <div id="wyszukaj" style="margin:10px">
                        ...
                        <div id="wyszukaj_text" style="margin-top:6px">
                            <span>Pokaż z ilością mniejszą od:</span>
                            <input type="text" name="ilosc" value="<?php echo $MinIlosc; ?>" size="4" class="calkowita" />
                            &nbsp; lub &nbsp; 
                            <input type="checkbox" name="alarm" id="alarm" value="1"  <?php echo ((isset($_GET['alarm']) && (int)$_GET['alarm'] == 1) ? 'checked="checked"' : ''); ?> /> <label class="OpisFor" for="alarm"><span>poniżej stanu alarmowego</span></label>
                        </div>      
                        ...
                        <div class="WyszukajRadio" style="margin-top:16px">                           
                        ...
                        <?php } else {
                            ...
                            ?>
                            <div class="wyszukaj_select" style="margin-right:20px;margin-top:8px">
                                <span>Kategoria:</span>
                        ...
                        if ( Listing::wylaczFiltr(basename($_SERVER['SCRIPT_NAME'])) == true ) {
                          echo '<div id="wyszukaj_ikona"><a href="statystyki/niskie_stany.php?filtr=nie"><img src="obrazki/reset_szukaj.png" alt="Anuluj wyszukiwanie" /></a></div>';
                        }
                        ?>                           

                        <div class="cl"></div> 

                        <div class="WyszukajCheckbox">                            
                            <input type="checkbox" name="aktywne" id="tylko_aktywne" value="1" <?php echo ((isset($_GET['aktywne']) && (int)$_GET['aktywne'] == 1) ? 'checked="checked"' : ''); ?> /> <label class="OpisFor" for="tylko_aktywne"><span>wyświetlaj tylko aktywne produkty</span></label>
                        </div>
                    ...
                    <div id="tryb_1" style="display:none">
                        ...
                        <div id="drzewo" style="margin-left:10px;max-width:650px;width:95%">
                            ...
                            for ($w = 0, $c = count($tablica_kat); $w < $c; $w++) {
                                ...
                                echo '<tr>
                                        <td class="lfp">
                                            <a href="statystyki/niskie_stany.php?kategoria_id='.$tablica_kat[$w]['id'].'">'.$tablica_kat[$w]['text'].(($tablica_kat[$w]['status'] == 0) ? '<em class="TipChmurka"><b>Kategoria jest nieaktywna</b><span class="wylKat"></span></em>' : '').'</a>
                                        </td>
                                        <td class="rgp" '.(($podkategorie) ? 'id="img_'.$tablica_kat[$w]['id'].'"' : '').'>'.(($podkategorie) ? '<img src="obrazki/rozwin.png" alt="Rozwiń" onclick="podkat(\''.$tablica_kat[$w]['id'].'\',\'\',\'\',\'\',\'niskie_stany\',\'statystyki\')" />' : '').'</td>
                                      </tr>
                    ...
                    if (!isset($_GET['alarm'])) {
                        $warunki_szukania .= " AND p.products_quantity < " . $MinIlosc;
                    }
                    if (isset($_GET['alarm']) && (int)$_GET['alarm'] == 1) {
                    ...
                    $zapytanie = 'SELECT DISTINCT
                                  ...
                                  WHERE pd.products_id = p.products_id AND pc.products_id = p.products_id AND (p.products_control_storage = "1" || p.products_control_storage = "2")
                    ...
                    if ((int)$db->ile_rekordow($sql) > 0) {
                        ...
                        echo '<td>Ilość</td>';
                        echo '<td style="text-align:center">Alarm magazynowy</td>';
                        echo '<td>Stan</td>';
                        echo '</tr>';                      
                        ...
                        while ($info = $sql->fetch_assoc()) {
                            ...
                            echo '<td class="wynikStat">'.(($info['products_quantity_alarm'] > 0) ? $info['products_quantity_alarm'] : '-').'</td>';
                    ...
                    <div id="DolneStrony">
                        ...
                        for ($c = 0; $c < $limit; $c++) {
                            ...
                            //
                            if ($c == 0) {
                                echo '<a class="Przycisk' . $Rozszerzenie . '" href="statystyki/niskie_stany.php">1</a>';
                              } else {
                                echo '<a class="Przycisk' . $Rozszerzenie . '" href="statystyki/niskie_stany.php?str='.$c.'">' . ($c + 1) . '</a>';
                            }
                        }
                        //
