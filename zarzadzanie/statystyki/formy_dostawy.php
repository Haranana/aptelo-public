            ...
            <div class="naglowek">Wybierane formy dostawy</div>
                ...
                <div class="pozycja_edytowana">  
                    ...
                    if ( Listing::wylaczFiltr(basename($_SERVER['SCRIPT_NAME'])) == true ) {
                      echo '<div id="wyszukaj_ikona"><a href="statystyki/formy_dostawy.php?filtr=nie"><img src="obrazki/reset_szukaj.png" alt="Anuluj wyszukiwanie" /></a></div>';
                    }
                    ?>                    
                    ...
                    <?php
                    $Wynik = '<div class="WykresStatystki"><div><canvas id="formy_dostawy" width="400" height="400"></canvas></div></div>';
                    //
                    $warunki_szukania = '';
                    ...
                    if ($SumaBylo == true) {
                        ...
                        include('statystyki/formy_dostawy_wykres.php');   
