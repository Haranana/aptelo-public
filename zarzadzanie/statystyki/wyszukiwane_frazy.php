...
if ($prot->wyswietlStrone) {
    ...
    if (isset($_GET['akcja']) && $_GET['akcja'] == 'usun_wszystko') {
        //			
        $db->delete_query('customers_searches' , " search_id != '0'");  
        //
        Funkcje::PrzekierowanieURL('wyszukiwane_frazy.php' . Funkcje::Zwroc_Get(array('akcja','zakres','id','x','y')));
    }    
                ...
                <div class="pozycja_edytowana">  
                        ...
                        <table>
                            <tr>
                                ...
                                while ($Lang = $sql->fetch_assoc()) {
                                    ...
                                    //
                                    echo '<td><a '.$klasaCSS.' href="statystyki/wyszukiwane_frazy.php?jezyk='.$Lang['languages_id'].'"><img src="../' . KATALOG_ZDJEC . '/'.$Lang['image'].'" alt="'.$Lang['name'].'" /></a></td>';
                                }
                                $db->close_query($sql);
                                unset($jezyki, $sql);                        
                                ?>
                    ...
                    if ((int)$db->ile_rekordow($sql) > 0) {
                        ...
                        <div class="WykresStatystki">
                            ...
                            <h3>
                                <?php
                                echo '20 najczęściej wyszukiwanych fraz w sklepie';
                                ?>
                            </h3>                    
                        
                            <div class="SzerokiWykres"><canvas id="wyszukiwane_frazy" width="800" height="230"></canvas></div>
                            
                        </div>  
                        
                        <?php
                        include('statystyki/wyszukiwane_frazy_wykres.php');
                        ?> 
                        
                        <br />
                        
                        <div style="margin:0px 0px 15px 10px">
                            <a class="usun" href="statystyki/wyszukiwane_frazy.php?akcja=usun_wszystko">usuń wszystkie dane</a>
                        </div>
                        ...
                        <div class="RamkaStatystyki">
                            ...
                            while ($info = $sql->fetch_assoc()) {
                                ...
                                echo '<td class="WyczyscStat"><a class="TipChmurka" href="statystyki/wyszukiwane_frazy.php?akcja=usun&id='.$info['search_id'].'"><b>Usuń tą frazę</b><img src="obrazki/kasuj.png" alt="Skasuj" /></a></td>';
                                echo '</tr>';
                        ...
                        <script src="statystyki/wyszukiwane_frazy_wykres.js"></script>                        
