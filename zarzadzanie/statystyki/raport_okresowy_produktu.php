            ...
            <div class="naglowek">Raport sprzedaży dla produktu w określonym przedziale czasowym</div>
                ...
                <div class="pozycja_edytowana">  
                    ...
                    if ( Listing::wylaczFiltr(basename($_SERVER['SCRIPT_NAME'])) == true ) {
                      echo '<div id="wyszukaj_ikona"><a href="statystyki/raport_okresowy_produktu.php?filtr=nie"><img src="obrazki/reset_szukaj.png" alt="Anuluj wyszukiwanie" /></a></div>';
                    }
                    ?>                    
                    ...
                    <form action="statystyki/raport_okresowy_produktu.php" method="post" id="statForm" class="cmxform">
                        ...
                        <p style="font-weight:bold;margin-bottom:10px" id="DodatkoweSzukanie">
                        Lub wyszukaj produkt do wyświetlania raportu
                        </p>   
                        ...
                        function fraza_stat() { 
                            ...
                            if ( fraza.length < 2 ) {
                                 ...
                                 $('.GlownyListingKategorieEdycja').hide();
                                 $('#DodatkoweSzukanie').html('Wyniki wyszukiwania dla frazy: <span style="color:#ff0000">' + fraza + '</span>');
                                 $('#wynik_produktow_raport_produkty .WynikNaglowekBrak').css({ 'margin-left' : '-10px' });
                                 return false;
                            }
                        }                        
                        </script>
                        ...
                        <div style="margin-left:10px;margin-top:7px;" id="fraza">
                            <div>Wyszukaj produkt: <input type="text" size="15" value="" id="szukany" /><em class="TipIkona"><b>Wpisz nazwę produktu lub kod producenta</b></em></div> <span onclick="fraza_stat();fraza_produkty()" ></span>
                        </div>                      
