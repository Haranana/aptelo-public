          ...
          <div class="poleForm">
            ...
            <div class="pozycja_edytowana">
                        ...
                        <div id="info_tab_id_<?php echo $w; ?>" style="display:none;">
                            ...
                            <p>
                               ...
                               <?php } else { ?>
                                ...
                                <input type="text" name="nazwa_<?php echo $w; ?>" id="nazwa_<?php echo $w; ?>" size="45" value="" />
                               <?php } ?>
                            </p> 
                ...
                <p>
                  ...
                  <input type="radio" value="6" name="typ_pola" id="pole_kalendarz" onclick="zmien_wartosc('<?php echo implode(',', (array)$tbjezyki); ?>','ukryj')" /><label class="OpisFor" for="pole_kalendarz">Input (kalendarz)<em class="TipIkona"><b>Pole tekstowe stworzone za pomocą znacznika INPUT - tylko wybór daty z kalendarza</b></em></label>
                  <input type="radio" value="1" name="typ_pola" id="pole_textarea" onclick="zmien_wartosc('<?php echo implode(',', (array)$tbjezyki); ?>','ukryj')" /><label class="OpisFor" for="pole_textarea">Textarea<em class="TipIkona"><b>Pole tekstowe stworzone za pomocą znacznika TEXTAREA pozwala na wpisanie wielu wierszy tekstu</b></em></label>
                  <input type="radio" value="2" name="typ_pola" id="pole_radio" onclick="zmien_wartosc('<?php echo implode(',', (array)$tbjezyki); ?>','pokaz')" /><label class="OpisFor" for="pole_radio">Radio Button<em class="TipIkona"><b>Pole jednokrotnego wyboru</b></em></label>
                  <input type="radio" value="3" name="typ_pola" id="pole_checkbox" onclick="zmien_wartosc('<?php echo implode(',', (array)$tbjezyki); ?>','pokaz')" /><label class="OpisFor" for="pole_checkbox">Checkbox<em class="TipIkona"><b>Pole wielokrotnego wyboru</b></em></label>
                  <input type="radio" value="4" name="typ_pola" id="pole_select" onclick="zmien_wartosc('<?php echo implode(',', (array)$tbjezyki); ?>','pokaz')" /><label class="OpisFor" for="pole_select">Drop down menu<em class="TipIkona"><b>Pole listy rozwijanej</b></em></label>
                </p> 
                ...
                <p>
                  ...
                  <input type="radio" value="1" name="wymagalnosc_pola" id="wymagane_tak" checked="checked" /> <label class="OpisFor" for="wymagane_tak">tak<em class="TipIkona"><b>Wypełnienie pola będzie wymagane podczas rejestracji klienta</b></em></label>
                  <input type="radio" value="0" name="wymagalnosc_pola" id="wymagane_nie" /> <label class="OpisFor" for="wymagane_nie">nie<em class="TipIkona"><b>Wypełnienie pola nie będzie wymagane podczas rejestracji klienta</b></em></label>
                </p> 

                <p>
                  <label>Opis pola:</label>
                  <input type="radio" value="1" name="etykieta" id="etykieta_tak" checked="checked" /><label class="OpisFor" for="etykieta_tak">tak<em class="TipIkona"><b>Będzie na stronie wyświetalna nazwa pola</b></em></label>
                  <input type="radio" value="0" name="etykieta" id="etykieta_nie" /><label class="OpisFor" for="etykieta_nie">nie<em class="TipIkona"><b>Nie będzie na stronie wyświetalna nazwa pola</b></em></label>
                </p> 
