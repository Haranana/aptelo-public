...
if ($prot->wyswietlStrone) {
    ...
    if ((int)$id_poz > 0) {
        ...
        $zapytanie = "SELECT fields_required_status FROM customers_extra_fields WHERE fields_id = ".(int)$_GET['id_poz'];
        ...
        if ((int)$db->ile_rekordow($sql) > 0) { 
            ...
            if ($info['fields_required_status'] == '1') {
                ...
                $db->update_query('customers_extra_fields' , $pola, " fields_id = '".(int)$_GET['id_poz']."'");
                unset($pola);                           
            }
