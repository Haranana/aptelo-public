...
if ($prot->wyswietlStrone) {
    ...
    if (isset($_POST['akcja']) && $_POST['akcja'] == 'zapisz') {
        //			
        $db->delete_query('print_labels' , " id = '".(int)$_POST["id"]."'");  
    ...
    <div id="cont">
          ...
          <form action="slowniki/etykiety_usun.php" method="post" class="cmxform">          
          ...
          <div class="poleForm">
            ...
            $zapytanie = "select * from print_labels where id = '" . (int)$_GET['id_poz'] . "' and label_default = '0'";
