          ...
          <div class="poleForm">
            ...
            <div class="pozycja_edytowana">
                ...
                <p>
                  ...
                  <input type="text" name="szerokosc" size="20" value="" id="szerokosc" class="required" /><em class="TipIkona"><b>Szerokość pojedynczej etykiety</b></em>
                </p>

                <p>
                  <label class="required" for="wysokosc">Wysokość [mm]:</label>
                  <input type="text" name="wysokosc" size="20" value="" id="wysokosc" class="required" /><em class="TipIkona"><b>Wysokość pojedynczej etykiety</b></em>
                </p>

                <p>
                  <label class="required" for="odstep">Odstęp poziomy [mm]:</label>
                  <input type="text" name="odstep" size="20" value="" id="odstep" class="required" /><em class="TipIkona"><b>Poziomy odstęp pomiędzy etykietami</b></em>
                </p>

                <p>
                  <label class="required" for="margines_gorny">Górny margines [mm]:</label>
                  <input type="text" name="margines_gorny" size="20" value="" id="margines_gorny" class="required" /><em class="TipIkona"><b>Margines od górnej krawędzi arkusza</b></em>
                </p>

                <p>
                  <label class="required" for="margines_lewy">Lewy margines [mm]:</label>
                  <input type="text" name="margines_lewy" size="20" value="" id="margines_lewy" class="required" /><em class="TipIkona"><b>Margines od lewej krawędzi arkusza</b></em>
                </p>

                <p>
                  <label class="required" for="kolumn">Ilość kolumn:</label>
                  <input type="text" name="kolumn" size="20" value="" id="kolumn" class="required" /><em class="TipIkona"><b>Ilość kolumn etykiet na pojedynczym arkuszu papieru</b></em>
                </p>

                <p>
                  <label class="required" for="wierszy">Ilość wierszy:</label>
                  <input type="text" name="wierszy" size="20" value="" id="wierszy" class="required" /><em class="TipIkona"><b>Ilość wierszy etykiet na pojedynczym arkuszu papieru</b></em>
                </p>
                ...
                <p>
                  ...
                  echo Funkcje::RozwijaneMenu('format', $tablica, 'A4', 'id="format"');
                  unset($tablica);
                ...
                <p>
                  ...
                  echo Funkcje::RozwijaneMenu('orientacja', $tablica, 'P', 'id="orientacja"');
                  unset($tablica);
                ...
                <p>
                  ...
                  <input type="radio" value="0" name="ramka" id="ramka_nie" checked="checked" /><label class="OpisFor" for="ramka_nie">nie</label>
                  <input type="radio" value="1" name="ramka" id="ramka_tak" /><label class="OpisFor" for="ramka_tak">tak</label>
                </p>
                    
                <p>
                  <label for="kolor_ramki">Kolor ramki:</label>
                  <input name="kolor_ramki" id="kolor_ramki" class="color" style="-moz-box-shadow:none" value="" size="8" />                    
                </p> 

                <p>
                  <label for="grubosc_ramki">Grubość ramki:</label>
                  <input type="text" name="grubosc_ramki" size="20" value="" id="grubosc_ramki" />
                </p>
