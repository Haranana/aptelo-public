...
if ($prot->wyswietlStrone) {
    ...
    $zapytanie = "SELECT pe.products_text_fields_id, 
                         ...
                         pe.products_text_fields_required, 
                         pei.products_text_fields_name, 
                         pe.products_text_fields_status
                    FROM products_text_fields pe, products_text_fields_info pei 
                   WHERE pei.products_text_fields_id = pe.products_text_fields_id AND pei.languages_id = '".(int)$_SESSION['domyslny_jezyk']['id']."' ORDER BY pe.products_text_fields_order";
    ...
    if (isset($_GET['parametr'])) {
        ...
        if ($ile_pozycji > 0) {
            ...
            while ($info = $sql->fetch_assoc()) {
                  ...
                  if ($info['products_text_fields_required'] == '1') { $obraz = 'aktywny_on.png'; $alt = 'Pole jest wymagane'; } else { $obraz = 'aktywny_off.png'; $alt = 'Pole nie jest wymagane'; }               
                  $tablica[] = array('<a class="TipChmurka" href="slowniki/dodatkowe_pola_tekstowe_wymagane.php?id_poz='.$info['products_text_fields_id'].'"><b>'.$alt.'</b><img src="obrazki/'.$obraz.'" alt="'.$alt.'" /></a>','center');
                  ...
                  $tablica[] = array('<a class="TipChmurka" href="slowniki/dodatkowe_pola_tekstowe_status.php?id_poz='.$info['products_text_fields_id'].'"><b>'.$alt.'</b><img src="obrazki/'.$obraz.'" alt="'.$alt.'" /></a>','center');
                  ...
                  $tekst .= '<a class="TipChmurka" href="slowniki/dodatkowe_pola_tekstowe_edytuj.php'.$zmienne_do_przekazania.'"><b>Edytuj</b><img src="obrazki/edytuj.png" alt="Edytuj" /></a>';
                  $tekst .= '<a class="TipChmurka" href="slowniki/dodatkowe_pola_tekstowe_usun.php'.$zmienne_do_przekazania.'"><b>Skasuj</b><img src="obrazki/kasuj.png" alt="Skasuj" /></a>';
