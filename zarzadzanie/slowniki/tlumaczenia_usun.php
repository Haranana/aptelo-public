...
if ($prot->wyswietlStrone) {
    ...
    if (isset($_POST['akcja']) && $_POST['akcja'] == 'zapisz') {
        ...
        $db->delete_query('translate_constant' , " translate_constant_id = '".(int)$_POST["id"]."'"); 
    ...
    <div id="cont">
          ...
          <div class="poleForm">
            ...
            $zapytanie = "select * from translate_constant where translate_constant_id = '" . (int)$_GET['id_poz'] . "'";
