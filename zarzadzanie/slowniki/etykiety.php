        ...
        if ($ile_pozycji > 0) {
            ...
            while ($info = $sql->fetch_assoc()) {
                  ...
                  $tablica = array(array($info['id'],'center'),
                                   ...
                                   array($info['kolumny'],'center'),
                                   array($info['wiersze'],'center')
                  );  

                  // domyslny
                  if ($info['label_default'] == '1') { $obraz = '<em class="TipChmurka"><b>Ta etykieta jest domyślna</b><img src="obrazki/aktywny_on.png" alt="Ta etykieta jest domyślna" /></em>'; } else { $obraz = '-'; }              
                  ...
                  $tekst .= '<a class="TipChmurka" href="slowniki/etykiety_edytuj.php'.$zmienne_do_przekazania.'"><b>Edytuj</b><img src="obrazki/edytuj.png" alt="Edytuj" /></a>';
                  if ( $info['label_default'] != '1' ) {
                    $tekst .= '<a class="TipChmurka" href="slowniki/etykiety_usun.php'.$zmienne_do_przekazania.'"><b>Skasuj</b><img src="obrazki/kasuj.png" alt="Skasuj" /></a>';
                  } else {
                    $tekst .= '<em class="TipChmurka"><b>Nie można usunąć domyślnej pozycji</b><img src="obrazki/kasuj_off.png" alt="Nie można usunąć domyslnej pozycji" /></em>';
                  }
