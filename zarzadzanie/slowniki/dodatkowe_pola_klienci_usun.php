...
if ($prot->wyswietlStrone) {
    ...
    if (isset($_POST['akcja']) && $_POST['akcja'] == 'zapisz') {
        ...
        //			
        $db->delete_query('customers_extra_fields' , " fields_id = '".(int)$_POST["id"]."'");
        $db->delete_query('customers_extra_fields_info' , " fields_id = '".(int)$_POST["id"]."'");
        $db->delete_query('customers_to_extra_fields' , " fields_id = '".(int)$_POST["id"]."'");
            ...
            if ((int)$db->ile_rekordow($sql) > 0) {
                ...
                <div class="pozycja_edytowana">
                    ...
                    <p>
                      ...
                      <?php
                      $sprawdzenie = "select fields_id from customers_to_extra_fields where fields_id = '" . (int)$_GET['id_poz'] . "'";
