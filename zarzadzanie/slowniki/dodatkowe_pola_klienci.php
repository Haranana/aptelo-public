...
if ($prot->wyswietlStrone) {
    ...
    $zapytanie = "SELECT ce.fields_id, ce.fields_order, ce.fields_input_type, ce.fields_required_status, cei.fields_name, ce.fields_status, ce.fields_input_type, ce.fields_type FROM customers_extra_fields ce, customers_extra_fields_info cei WHERE cei.fields_id = ce.fields_id AND cei.languages_id = '".(int)$_SESSION['domyslny_jezyk']['id']."' ORDER BY ce.fields_order";
    ...
    if (isset($_GET['parametr'])) {
        ...
        if ($ile_pozycji > 0) {
            ...
            while ($info = $sql->fetch_assoc()) {
                  ...
                  $tablica[] = array('<a class="TipChmurka" href="slowniki/dodatkowe_pola_klienci_wymagane.php?id_poz='.$info['fields_id'].'"><b>'.$alt.'</b><img src="obrazki/'.$obraz.'" alt="'.$alt.'" /></a>','center');
                  ...
                  $tablica[] = array('<a class="TipChmurka" href="slowniki/dodatkowe_pola_klienci_status.php?id_poz='.$info['fields_id'].'"><b>'.$alt.'</b><img src="obrazki/'.$obraz.'" alt="'.$alt.'" /></a>','center');
                  ...
                  $tekst .= '<a class="TipChmurka" href="slowniki/dodatkowe_pola_klienci_edytuj.php'.$zmienne_do_przekazania.'"><b>Edytuj</b><img src="obrazki/edytuj.png" alt="Edytuj" /></a>';
                  $tekst .= '<a class="TipChmurka" href="slowniki/dodatkowe_pola_klienci_usun.php'.$zmienne_do_przekazania.'"><b>Skasuj</b><img src="obrazki/kasuj.png" alt="Skasuj" /></a>';
