...
if ($prot->wyswietlStrone) {
    ...
    if (isset($_POST['akcja']) && $_POST['akcja'] == 'zapisz') {
        //			
        $db->delete_query('products_condition' , " products_condition_id = '".(int)$_POST["id"]."'");  
        $db->delete_query('products_condition_description' , " products_condition_id = '".(int)$_POST["id"]."'"); 
        //
        // usuwa wpis w produktach
        $pola = array(
                array('products_condition_products_id','')
        );        
        $db->update_query('products' , $pola, " products_condition_products_id = '".(int)$_POST["id"]."'");
        //        
    ...
    <div id="cont">
          ...
          <form action="slowniki/stan_produktu_usun.php" method="post" class="cmxform">          
