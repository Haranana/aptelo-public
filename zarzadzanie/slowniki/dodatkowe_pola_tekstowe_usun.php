...
if ($prot->wyswietlStrone) {
    ...
    if (isset($_POST['akcja']) && $_POST['akcja'] == 'zapisz') {
        ...
        //			
        $db->delete_query('products_text_fields' , " products_text_fields_id = '".(int)$_POST["id"]."'");
        $db->delete_query('products_text_fields_info' , " products_text_fields_id = '".(int)$_POST["id"]."'");
        $db->delete_query('products_to_text_fields' , " products_text_fields_id = '".(int)$_POST["id"]."'");
            ...
            if ((int)$db->ile_rekordow($sql) > 0) {
                ...
                <div class="pozycja_edytowana">
                    ...
                    <p>
                      ...
                      <?php
                      $sprawdzenie = "select products_text_fields_id from products_to_text_fields where products_text_fields_id = '" . (int)$_GET['id_poz'] . "'";
