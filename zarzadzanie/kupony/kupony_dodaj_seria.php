          ...
          <div class="poleForm">
            ...
            <div class="pozycja_edytowana">
                ...
                <input type="hidden" name="akcja" value="zapisz" />
                    ...
                    <p>
                      <label class="required" for="liczba_od">Zakres liczbowy od:</label>
                      <input type="text" name="liczba_od" id="liczba_od" value="" size="10" /><em class="TipIkona"><b>Wartość liczbowa powyżej 0</b></em>
                    </p>

                    <p>
                      <label class="required" for="liczba_do">Zakres liczbowy do:</label>
                      <input type="text" name="liczba_do" id="liczba_do" value="" size="10" /><em class="TipIkona"><b>Wartość liczbowa powyżej 0</b></em>
                    </p>                    
                    ...
                    <div class="RamkaWarunki">
                        ...
                        <p>
                          ...
                          <input type="text" name="ilosc" id="ilosc" value="" size="3" /><em class="TipIkona"><b>Ilość produktów w koszyku od jakiej będzie można zrealizować kupon</b></em>
                        </p> 
