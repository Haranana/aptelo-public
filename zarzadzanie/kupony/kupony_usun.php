...
if ($prot->wyswietlStrone) {
    ...
    if (isset($_POST['akcja']) && $_POST['akcja'] == 'zapisz') {
        ...
        $id_kuponu = (int)$_POST['id'];
    
        // kasuje rekordy w tablicy
        $db->delete_query('coupons' , " coupons_id = '".$id_kuponu."'"); 
        $db->delete_query('coupons_to_customers' , " coupons_id = '".$id_kuponu."'");     
        $db->delete_query('coupons_to_orders' , " coupons_id = '".$id_kuponu."'");            
    ...
    <div id="cont">
          ...
          <form action="kupony/kupony_usun.php" method="post" class="cmxform">          
