...
if ($prot->wyswietlStrone) {
    ...
    <div id="cont">
          ...
          <form action="allegro/allegro_aukcja_wznow.php" method="post" class="cmxform" id="allegroForm" >          

          <div class="poleForm">
            <div class="naglowek">Wznowienie aukcji</div>
            ...
            if ((int)$db->ile_rekordow($sql) > 0) {
                ...
                if ( $_SESSION['domyslny_uzytkownik_allegro'] == $info['auction_seller'] ) {
                    ...
                    <div class="pozycja_edytowana">
                        ...
                        <p>
                          Czy wznowić aukcję numer <?php echo $info['auction_id']; ?> ?
                        </p>                    
                    ...
                    <div class="przyciski_dolne">
                      <input type="submit" class="przyciskNon" value="Wznów aukcję" />
