...
if ($prot->wyswietlStrone) {
    ...
    if (isset($_POST['akcja']) && $_POST['akcja'] == 'zapisz') {
        //			
        $db->delete_query('allegro_theme' , " allegro_theme_id = '" . (int)$_POST["id"] . "'");       
        //
        Funkcje::PrzekierowanieURL('szablony.php');
    }
    ...
    <div id="cont">
          ...
          <form action="allegro/szablony_nowy_usun.php" method="post" class="cmxform">          
          ...
          <div class="poleForm">
            ...
            if ((int)$db->ile_rekordow($sql) > 0) {
                ...
                <div class="pozycja_edytowana">
                    ...
                    <input type="hidden" name="id" value="<?php echo (int)$_GET['id_nowy']; ?>" />
                    
                    <p>
                      Czy skasować szablon ?
                    </p>   
