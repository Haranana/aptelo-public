                      ...
                      if ( $NowaIloscAllegro > 0 ) {
                          ...
                          if ( $info['auction_quantity'] != $IloscMagazyn ) {
                                  ...
                                  if ( is_object($rezultat) && !isset($rezultat->errors) ) {
                                      ...
                                      echo '<span>Aukcja o nr <b>' . $id_aukcji . '</b> - ilość produktów na aukcji została zaktualizowana ' . ((isset($info['products_name'])) ? '- produkt: ' . $info['products_name'] : '') . '</span> <br />';
                          ...
                          echo '<span style="color:#ff0000">Aukcja o nr <b>' . (int)$_POST['id_aukcji'] . '</b> - ilość produktów na Allegro nie może być równa 0 ' . ((isset($info['products_name'])) ? '- produkt: <b>' . $info['products_name'] : '') . '</b></span> <br />';
