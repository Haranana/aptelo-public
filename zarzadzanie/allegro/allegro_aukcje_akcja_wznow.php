    ...
    if ( Funkcje::SprawdzAktywneAllegro() ) {
        ...
        if ( isset($_POST['ajax']) ) {
            ...
            if ( isset($_POST['akcja_dolna']) && isset($_POST['opcja']) && count($_POST['opcja']) > 0 ) {
                ...
                <div id="naglowek_cont">Wznowienie zakończonych aukcji</div>
                
                <div id="cont">
                      
                    <form action="allegro/allegro_aukcje_akcja_wznow.php" method="post" class="cmxform">          

                    <div class="poleForm">
                    
                      <div class="naglowek">Wznowienie zakończonych aukcji</div>
                      
                      <div class="pozycja_edytowana">

                          <?php if ( $_POST['akcja_dolna'] != 'wznow' ) { ?>
                      
                              <input type="hidden" name="akcja" value="wznow" />  
                              <input type="hidden" name="akcja_dolna" value="wznow" />
                          
                              <p>
                                Czy wznowić poniższe aukcje produktów ?
                              </p> 
                              ...
                              <p class="ListaAukcji">
                                ...
                                while ( $info = $sql->fetch_assoc() ) {
                                    ...
                                    if ( $info['auction_status'] == 'ENDED' ) {

                                        if ( $info['auction_quantity'] > 0 ) {
                                            ...
                                            echo '<a href="' . $link . '" target="_blank" style="color:red">' . $info['auction_id'] . '</a> - ' . $info['products_name'] . ' - tej aukcji nie można wznowić ponieważ ilość produktów w Allegro jest równa 0<br />';
                                        }
                          ...
                          <?php } else { ?>
                              ...
                              if ( Funkcje::SprawdzAktywneAllegro() ) {
                                  ...
                                  function allegro_dane(nr) {
                                    ...
                                    $.post( "allegro/allegro_aukcje_akcja_wznow.php?tok=<?php echo Sesje::Token(); ?>", 
                                      { 
                      ...
                      <div class="przyciski_dolne" id="przyciski" <?php echo (( $_POST['akcja_dolna'] == 'wznow' )  ? 'style="display:none"' : ''); ?>>
                        
                        <?php if ( $_POST['akcja_dolna'] != 'wznow' && $Aktualizuj ) { ?>
