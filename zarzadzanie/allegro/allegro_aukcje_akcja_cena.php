    ...
    if ( Funkcje::SprawdzAktywneAllegro() ) {
        ...
        if ( isset($_POST['ajax']) ) {
                ...
                if ( $db->ile_rekordow($sql) > 0 ) {
                    ...
                    if ( $cena_sklep > 0 ) {
                        ...
                        if ( is_object($rezultat) && !isset($rezultat->errors) ) {
                            ...
                            $pola = array(array('products_buy_now_price', (float)$cena_sklep));
            ...
            if ( isset($_POST['akcja_dolna']) && isset($_POST['opcja']) && count($_POST['opcja']) > 0 ) {
                ...
                <div id="naglowek_cont">Aktualizacja cen produktów na aukcjach</div>
                
                <div id="cont">
                      
                    <form action="allegro/allegro_aukcje_akcja_cena.php" method="post" class="cmxform">          

                    <div class="poleForm">
                    
                      <div class="naglowek">Synchronizacja cen produktów na aukcjach z cenami produktów w sklepie</div>
                          ...
                          <?php } else { ?>
                              ...
                              if ( Funkcje::SprawdzAktywneAllegro() ) {
                                  ...
                                  function allegro_dane(nr) {
                                    ...
                                    $.post( "allegro/allegro_aukcje_akcja_cena.php?tok=<?php echo Sesje::Token(); ?>", 
                                      { 
