...
if ($prot->wyswietlStrone) {
    ...
    if (isset($_POST['akcja']) && $_POST['akcja'] == 'zapisz') {
        //			
        $db->delete_query('allegro_auctions' , " allegro_id = '".(int)$_POST["id"]."'");  
        $db->delete_query('allegro_auctions_sold' , " auction_id = '".(int)$_POST["aukcja_id"]."'");  
        $db->delete_query('allegro_transactions' , " auction_id = '".(int)$_POST["aukcja_id"]."'");  
        //
