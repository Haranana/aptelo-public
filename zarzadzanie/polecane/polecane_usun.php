...
if ($prot->wyswietlStrone) {
    ...
    if (isset($_POST['akcja']) && $_POST['akcja'] == 'zapisz') {
        ...
        $pola = array(array('featured_status','0'),
                      array('featured_date','0000-00-00'),
                      array('featured_date_end','0000-00-00'));
    ...
    <div id="cont">
          ...
          <form action="polecane/polecane_usun.php" method="post" class="cmxform">          
          ...
          <div class="poleForm">
            ...
            if ((int)$db->ile_rekordow($sql) > 0) {
                ...
                <div class="pozycja_edytowana">
                    ...
                    <p>
                      Czy skasować ustawienia produktu polecanego dla tego produktu ?                    
                    </p>   
