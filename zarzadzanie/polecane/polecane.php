...
if ($prot->wyswietlStrone) {
    ...
    if ( isset($_GET['szukaj_data_rozpoczecia_od']) && $_GET['szukaj_data_rozpoczecia_od'] != '' ) {
        ...
        $warunki_szukania .= " and p.featured_date >= '".$szukana_wartosc."' and p.featured_date != '0000-00-00'";
    }
    ...
    if ( isset($_GET['szukaj_data_zakonczenia_od']) && $_GET['szukaj_data_zakonczenia_od'] != '' ) {
        ...
        $warunki_szukania .= " and p.featured_date_end >= '".$szukana_wartosc."' and p.featured_date_end != '0000-00-00'";
    }
    ...
    $warunki_szukania .= ' and ( p.featured_status = "1" or p.featured_date != "0000-00-00" or p.featured_date_end != "0000-00-00" ) ';
    ...
    if (isset($_GET['sort'])) {
        switch ($_GET['sort']) {
            ...
            case "sort_a2":
                ...
                break;
            case "sort_a3":
                $sortowanie = 'p.featured_status desc, pd.products_name, p.products_id';
                break;  
            case "sort_a4":
                $sortowanie = 'p.featured_status asc, pd.products_name, p.products_id';
                break;                        
            case "sort_a7":
            ...
            case "sort_a10":
                ...
                break;  
            case "sort_a11":
                $sortowanie = 'p.featured_date asc, pd.products_name, p.products_id';
                break;
            case "sort_a12":
                $sortowanie = 'p.featured_date desc, pd.products_name, p.products_id';
                break;                            
            case "sort_a13":
                $sortowanie = 'p.featured_date_end asc, pd.products_name, p.products_id';
                break;
            case "sort_a14":
                $sortowanie = 'p.featured_date_end desc, pd.products_name, p.products_id';
                break; 
            case "sort_a15":
    ...
    if (isset($_GET['parametr'])) {
        ...
        if ($ile_pozycji > 0) {
            ...
            while ($info = $sql->fetch_assoc()) {
                  ...
                  $tablica[] = array(((Funkcje::czyNiePuste($info['featured_date'])) ? date('d-m-Y',FunkcjeWlasnePHP::my_strtotime($info['featured_date'])) : '-'),'center','white-space:nowrap'); 

                  $tablica[] = array(((Funkcje::czyNiePuste($info['featured_date_end'])) ? date('d-m-Y',FunkcjeWlasnePHP::my_strtotime($info['featured_date_end'])) : '-'),'center','white-space:nowrap');                     
                  ...
                  // wyswietlany czy nie
                  if ($info['featured_status'] == '1') { $obraz = 'aktywny_on.png'; $alt = 'Ten produkt jest wyświetlany jako polecany'; } else { $obraz = 'aktywny_off.png'; $alt = 'Ten produkt nie jest wyświetlany jako polecany'; }               
                  $tablica[] = array('<em class="TipChmurka"><b>'.$alt.'</b><img src="obrazki/'.$obraz.'" alt="" /></em>','center');                                       
                  ...
                  $tekst .= '<a class="TipChmurka" href="polecane/polecane_edytuj.php'.$zmienne_do_przekazania.'"><b>Edytuj</b><img src="obrazki/edytuj.png" alt="Edytuj" /></a>'; 
                  $tekst .= '<a class="TipChmurka" href="polecane/polecane_usun.php'.$zmienne_do_przekazania.'"><b>Skasuj</b><img src="obrazki/kasuj.png" alt="Skasuj" /></a>';
    ...
    if (!isset($_GET['parametr'])) { 
        ...
        $(document).ready(function() {
          $.AutoUzupelnienie( 'szukaj', 'Podpowiedzi', 'ajax/autouzupelnienie_produkty.php?typ=polecany', 50, 350 );
        ...
        <div id="caly_listing">
            ...
            <div id="naglowek_cont">Produkty polecane</div>
            
            <div id="wyszukaj">
                <form action="polecane/polecane.php" method="post" id="poForm" class="cmxform"> 
                ...
                if ( Listing::wylaczFiltr(basename($_SERVER['SCRIPT_NAME'])) == true ) {
                  echo '<div id="wyszukaj_ikona"><a href="polecane/polecane.php?filtr=nie"><img src="obrazki/reset_szukaj.png" alt="Anuluj wyszukiwanie" /></a></div>';
                }
                ?>             
            ...
            <form action="polecane/polecane_akcja.php" method="post" class="cmxform">
            
            <div id="sortowanie">
            
                <span>Sortowanie: </span>
                
                <a id="sort_a1" class="sortowanie" href="polecane/polecane.php?sort=sort_a1">brak</a>
                <a id="sort_a17" class="sortowanie" href="polecane/polecane.php?sort=sort_a17">nazwy rosnąco</a>
                <a id="sort_a2" class="sortowanie" href="polecane/polecane.php?sort=sort_a2">nazwy malejąco</a>
                <a id="sort_a7" class="sortowanie" href="polecane/polecane.php?sort=sort_a7">nr katalogowy rosnąco</a>
                <a id="sort_a8" class="sortowanie" href="polecane/polecane.php?sort=sort_a8">nr katalogowy malejąco</a> 
                <a id="sort_a9" class="sortowanie" href="polecane/polecane.php?sort=sort_a9">cena rosnąco</a>
                <a id="sort_a10" class="sortowanie" href="polecane/polecane.php?sort=sort_a10">cena malejąco</a>             
                <a id="sort_a20" class="sortowanie" href="polecane/polecane.php?sort=sort_a20">aktywne</a>
                <a id="sort_a21" class="sortowanie" href="polecane/polecane.php?sort=sort_a21">nieaktywne</a>                 
                <a id="sort_a3" class="sortowanie" href="polecane/polecane.php?sort=sort_a3">widoczne</a>
                <a id="sort_a4" class="sortowanie" href="polecane/polecane.php?sort=sort_a4">niewidoczne</a>
                <a id="sort_a11" class="sortowanie" href="polecane/polecane.php?sort=sort_a11">daty rozpoczęcia od</a>
                <a id="sort_a12" class="sortowanie" href="polecane/polecane.php?sort=sort_a12">daty rozpoczęcia do</a> 
                <a id="sort_a13" class="sortowanie" href="polecane/polecane.php?sort=sort_a13">daty zakończenia od</a>
                <a id="sort_a14" class="sortowanie" href="polecane/polecane.php?sort=sort_a14">daty zakończenia do</a>                 
                <a id="sort_a15" class="sortowanie" href="polecane/polecane.php?sort=sort_a15">ID malejąco</a>
                <a id="sort_a16" class="sortowanie" href="polecane/polecane.php?sort=sort_a16">ID rosnąco</a>      
                <a id="sort_a18" class="sortowanie" href="polecane/polecane.php?sort=sort_a18">sortowanie malejąco</a>
                <a id="sort_a19" class="sortowanie" href="polecane/polecane.php?sort=sort_a19">sortowanie rosnąco</a>                      
            ...
            <?php
            // przycisk dodania nowego polecanego
            ?>
            <div id="PozycjeIkon">
                <div>
                    <a class="dodaj" href="polecane/polecane_dodaj.php">dodaj nowy produkt polecany</a>
                </div>         
            </div>
                ...
                <div class="GlownyListingKategorie">
                    ...
                    <div class="OknoKategoriiKontener">
                        ...
                        for ($w = 0, $c = count($tablica_kat); $w < $c; $w++) {
                            ...
                            //
                            echo '<tr>
                                    <td class="lfp"><a href="polecane/polecane.php?kategoria_id='.$tablica_kat[$w]['id'].'" '.$style.'>'.$tablica_kat[$w]['text'].'</a></td>
                                    <td class="rgp" '.(($podkategorie) ? 'id="img_'.$tablica_kat[$w]['id'].'"' : '').'>'.(($podkategorie) ? '<img src="obrazki/rozwin.png" alt="Rozwiń" onclick="podkat(\''.$tablica_kat[$w]['id'].'\',\'\',\'\',\'\',\'polecane\')" />' : '').'</td>
                                  </tr>
                        ...
                        if (isset($_GET['kategoria_id']) && (int)$_GET['kategoria_id'] > 0) {
                            ...
                            if (count($cSciezka) > 1) {
                                ...
                                <script>          
                                podkat('<?php echo $analiza_sciezki; ?>', '<?php echo $cSciezka[count($cSciezka)-1]; ?>','','','polecane');
                                </script>
                    ...
                    <div id="akcja" class="AkcjaOdstep">
                        ...
                        <div id="akc">
                            ...
                            <select name="akcja_dolna" id="akcja_dolna">
                                ...
                                <option value="1">usuń polecany z zaznaczonych produktów</option>
                                <?php
                                /*
            ...
            <?php Listing::pokazAjax('polecane/polecane.php', $zapytanie, $ile_licznika, $ile_pozycji, 'products_id', ILOSC_WYNIKOW_NA_STRONIE, ADMIN_DOMYSLNE_SORTOWANIE); ?>
            </script>              
