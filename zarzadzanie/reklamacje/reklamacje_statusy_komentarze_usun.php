...
if ($prot->wyswietlStrone) {
    ...
    if (isset($_POST['akcja']) && $_POST['akcja'] == 'zapisz') {
        //			
        $db->delete_query('standard_complaints_comments' , " comments_id = '".(int)$_POST["id"]."'");  
        $db->delete_query('standard_complaints_comments_description' , " comments_id = '".(int)$_POST["id"]."'"); 
        //
        Funkcje::PrzekierowanieURL('reklamacje_statusy_komentarze.php?status_id='.(int)$_POST["status_id"]);
    }
