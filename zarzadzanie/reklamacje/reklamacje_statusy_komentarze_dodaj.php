...
if ($prot->wyswietlStrone) {
    ...
    if (isset($_POST['akcja']) && $_POST['akcja'] == 'zapisz') {
        ...
        //	
        $db->insert_query('standard_complaints_comments' , $pola);
        ...
        //
        Funkcje::PrzekierowanieURL('reklamacje_statusy_komentarze.php?id_poz='.(int)$id_dodanej_pozycji.'&status_id='.(int)$_POST["status_id"]);
    }
    ...
    <div id="naglowek_cont">Dodanie komentarza reklamacji dla statusu - <?php echo Reklamacje::pokazNazweStatusuReklamacji((int)$_GET['status_id']); ?></div>
    <div id="cont">
          ...
          <form action="reklamacje/reklamacje_statusy_komentarze_dodaj.php" method="post" id="reklamForm" class="cmxform">          
          ...
          <div class="poleForm">
            ...
            <div class="przyciski_dolne">
              ...
              <button type="button" class="przyciskNon" onclick="cofnij('reklamacje_statusy_komentarze','<?php echo Funkcje::Zwroc_Wybrane_Get(array('status_id')); ?>','reklamacje');">Powrót</button>   
            </div>            
