...
if ($prot->wyswietlStrone) {
    ...
    if (isset($_POST['akcja']) && $_POST['akcja'] == 'zapisz') {
        //			
        $db->delete_query('subscribers' , " subscribers_id = '".(int)$_POST["id"]."'");  
        //
        // wylaczanie newslettera w kliencie jezeli kasowana pozycja to klient
        $pola = array(
    ...
    <div id="cont">
          ...
          <form action="newsletter/newsletter_subskrybenci_usun.php" method="post" class="cmxform">          
          ...
          <div class="poleForm">
            ...
            $zapytanie = "select * from subscribers where subscribers_id = '" . (int)$_GET['id_poz'] . "'";
            ...
            if ((int)$db->ile_rekordow($sql) > 0) {
                ...
                <div class="pozycja_edytowana">
                    ...
                    <input type="hidden" name="email" value="<?php echo $info['subscribers_email_address']; ?>" />
