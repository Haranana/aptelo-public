...
if ($prot->wyswietlStrone) {
    ...
    <div id="cont">
          ...
          <form action="newsletter/newsletter_freshmail_wyslij.php" method="post" id="newsForm" class="cmxform">          

          <div class="poleForm">
            <div class="naglowek">Eksport danych do systemu Freshmail</div>
            ...
            <div class="pozycja_edytowana">
                ...
                <div class="maleInfo">
                  Jeżeli lista nie istnieje w systemie FreshMail - zostanie utworzona. Jeżeli w systemie będzie istniał eksportowany adres email - zostanie pominięty, a lista w FreshMail zostanie zaktualizowana tylko o nowe wpisy.
                </div>
                ...
                <p>
                  ...
                  <em class="TipIkona"><b>Nazwa listy odbiorców w systemie FreshMail do której mają zostać wyeksportowane adresy mailowe</b></em>
                </p>
            ...
            <div class="pozycja_edytowana">
                ...
                <div style="padding:10px">Integracja z FreshMail nie jest aktywna ...</div>
