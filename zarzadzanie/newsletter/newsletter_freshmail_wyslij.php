...
if ($prot->wyswietlStrone && isset($_POST['akcja']) && $_POST['akcja'] == 'wyslij' && isset($_POST['lista']) && trim((string)$_POST['lista']) != '' && INTEGRACJA_FRESHMAIL_WLACZONY == 'tak' ) {

    // wczytanie naglowka HTML
    include('naglowek.inc.php');
    ?>
    
    <div id="naglowek_cont">Wysyłanie danych do systemu Freshmail</div>
    <div id="cont">
          
          <form action="newsletter/newsletter_freshmail_wyslij.php" method="post" class="cmxform">          
          ...
          <div class="poleForm">
            ...
            if ( $IloscPozycji > 0) {
                ...
                //
                function wyslij_freshmail(tryb, limit, suma) {
                    ...
                    $.post( "ajax/wyslij_freshmail.php?tok=<?php echo Sesje::Token(); ?>", 
                          { 
                            tryb: '<?php echo $Tryb; ?>',
                          ...
                          function(data) {
                             ...
                             $('#procent').html('Stopień realizacji: <span>' + procent + '%</span><br />Przesłano do systemu Freshmail maili: <span>' + data + '</span>');
                             
                             $('#suwak_aktywny').css('width' , (procent * 5) + 5 + 'px');
                             
                             if (ogolny_limit-1 > limit) {
                               
                                 wyslij_freshmail('<?php echo $Tryb; ?>', limit + 20, data);
                ...
                <div class="pozycja_edytowana">
                    ...
                    <div id="wynik_dzialania" style="display:none">
                        Dane zostały przesłane do Freshmail ...
                    </div>
                ...
                <script>
                wyslij_freshmail('<?php echo $Tryb; ?>',0,0)
                </script>
