...
if ($prot->wyswietlStrone) {
    ...
    <div id="cont">
          ...
          <form action="newsletter/newsletter_ecomail_wyslij.php" method="post" id="newsForm" class="cmxform">          

          <div class="poleForm">
            <div class="naglowek">Eksport danych do systemu Ecomail</div>
            ...
            <div class="pozycja_edytowana">
                ...
                <div class="maleInfo">
                  Jeżeli lista nie istnieje w systemie Ecomail - zostanie utworzona. Jeżeli w systemie będzie istniał eksportowany adres email - zostanie pominięty, a lista w Ecomail zostanie zaktualizowana tylko o nowe wpisy.
                </div>
                ...
                <p>
                  ...
                  <em class="TipIkona"><b>Nazwa listy odbiorców w systemie Ecomail do której mają zostać wyeksportowane adresy mailowe</b></em>
                </p>
            ...
            <div class="pozycja_edytowana">
                ...
                <div style="padding:10px">Integracja z Ecomail nie jest aktywna ...</div>
