...
if ($prot->wyswietlStrone) {
    ...
    if (isset($_POST['akcja']) && $_POST['akcja'] == 'zapisz') {
        //
        $id_klienta = (int)$_POST['id'];
        //			
        $db->delete_query('pp_banners' , " id = '".(int)$_GET["id_poz"]."'");
        //
    ...
    <div id="cont">
          ...
          <form action="program_partnerski/bannery_usun.php<?php echo Funkcje::Zwroc_Get(); ?>" method="post" class="cmxform">          
          ...
          <div class="poleForm">
            ...
            $zapytanie = "select distinct * from pp_banners where id = '".(int)$_GET["id_poz"]."'";
