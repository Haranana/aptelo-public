...
if ($prot->wyswietlStrone) {
    ...
    if (isset($_POST['akcja']) && $_POST['akcja'] == 'zapisz') {
        ...
        $db->delete_query('products_accesories' , " pacc_products_id_master = '".$id_prod."' and pacc_type = 'produkt'");     
    ...
    <div id="cont">
          ...
          <form action="akcesoria_dodatkowe/akcesoria_dodatkowe_usun.php" method="post" class="cmxform">          
          ...
          <div class="poleForm">
            ...
            if ((int)$db->ile_rekordow($sql) > 0) {
                ...
                <div class="pozycja_edytowana">
                    ...
                    <p>
                      Czy skasować wszystkie przypisane akcesoria dodatkowe dla tego produktu ?                    
                    </p>   
