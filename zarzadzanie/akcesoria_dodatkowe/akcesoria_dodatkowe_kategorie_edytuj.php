...
if ($prot->wyswietlStrone) {
    ...
    <div id="cont">
          ...
          <form action="akcesoria_dodatkowe/akcesoria_dodatkowe_kategorie_edytuj.php" method="post" id="akcesoria_dodatkoweForm" class="cmxform"> 
          ...
          <div class="poleForm">
            ...
            $zapytanie = "select distinct * from products_accesories where pacc_products_id_master = '".(int)$_GET['id_poz']."' and pacc_type = 'kategoria'";
            ...
            if ((int)$db->ile_rekordow($sql) > 0) {
                ...
                <div class="pozycja_edytowana">    
                    ...
                    <div id="formi">
                        ...
                        <script>
                        lista_akcja_kategoria('<?php echo (int)$_GET['id_poz']; ?>');
                        dodaj_do_listy('','0');
                        </script>                          
