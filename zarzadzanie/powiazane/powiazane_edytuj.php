...
if ($prot->wyswietlStrone) {
    ...
    if (isset($_POST['akcja']) && $_POST['akcja'] == 'zapisz') {
        ...
        $db->delete_query('products_related_products' , " prp_products_id_master = '".(int)$glowne_id."'");           
        //
            ...
            if (isset($_POST['id_produktow'])) {
                ...
                if (count($_POST['id_produktow']) > 0) {
                    ...
                    foreach ($_POST['id_produktow'] as $pole) {
                        ...
                        $zapytanie = "select distinct * from products_related_products where prp_products_id_master = '".(int)$glowne_id."' and prp_products_id_slave = '".(int)$pole."'";
    ...
    <div id="cont">
          ...
          <form action="powiazane/powiazane_edytuj.php" method="post" id="powiazaneForm" class="cmxform"> 
          ...
          <div class="poleForm">
            ...
            $zapytanie = "select distinct * from products_related_products where prp_products_id_master = '".(int)$_GET['id_poz']."'";
            ...
            if ((int)$db->ile_rekordow($sql) > 0) {
                ...
                <div class="pozycja_edytowana">    
                    ...
                    <div id="drzewo_powiazane" style="display:none"></div>     
                    ...
                    <div id="formi">
                        ...
                        while ($info = $sql->fetch_assoc()) {
                            $do_id .= ',' . $info['prp_products_id_slave'];
                        }
                        $do_id = $do_id . ',';
                        ?>
                        ...
                        <script>
                        lista_akcja('<?php echo (int)$_GET['id_poz']; ?>','powiazane');
                        dodaj_do_listy('','0');
                        </script>                          
                ...
                <div class="przyciski_dolne">
                  ...
                  <?php } else { ?>
                     <button type="button" class="przyciskNon" onclick="cofnij('powiazane','<?php echo Funkcje::Zwroc_Wybrane_Get(array('id_poz')); ?>');">Powrót</button>    
                  <?php } ?>                  
