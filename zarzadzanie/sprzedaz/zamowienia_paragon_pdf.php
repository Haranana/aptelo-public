...
if ($prot->wyswietlStrone) {
  ...
  $i18n = new Translator($db, ((isset($_GET['jezyk']) && (int)$_GET['jezyk'] > 0) ? (int)$_GET['jezyk'] : $_SESSION['domyslny_jezyk']['id']));
  ...
  $pdf->SetTitle($tlumacz['PARAGON']);
  $pdf->SetSubject($tlumacz['PARAGON']);
  $pdf->SetKeywords($tlumacz['PARAGON']);
  ...
  $text = PDFParagon::WydrukParagonuPDF((int)$_GET['id_poz'], (int)$_GET['id']);
  ...
  $pdf->Output('paragon_'.(int)$_GET['id_poz'].'_'.time().'.pdf', 'D');
