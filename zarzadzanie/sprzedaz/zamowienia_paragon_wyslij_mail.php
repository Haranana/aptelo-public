...
if ($prot->wyswietlStrone) {
    ...
    if (isset($_POST['akcja']) && $_POST['akcja'] == 'zapisz') {
        ...
        if ( isset($_POST['adresat']) && $_POST['adresat'] != '') {
            ...
            $text = PDFParagon::WydrukParagonuPDF((int)$_GET['id_poz'], (int)$_GET['id'], '2', '');
            ...
            $plik = KATALOG_SKLEPU . 'zarzadzanie/tmp/paragon-zamowienie-nr-' . (int)$_GET['id_poz'] . '-uniq-' . time() . '.pdf';
            ...
            array_map('unlink', glob(KATALOG_SKLEPU . "zarzadzanie/tmp/paragon-zamowienie-nr-*"));
            
            $pola = array(array('receipts_date_send', 'now()'));
            $db->update_query('receipts' , $pola, "receipts_id = '" . (int)$_GET['id'] . "'");
            unset($pola);              
        ...
        Funkcje::PrzekierowanieURL('zamowienia_paragon_wyslij_mail.php?id_poz=' . (int)$_GET["id_poz"] . '&wyslano');
    }
    ...
    <div id="naglowek_cont">Wysłanie wiadomości e-mail z paragonem do klienta</div>
    <div id="cont">
        ...
        ?>
            ...
            <div class="poleForm">
                ...
                <div class="naglowek">Wysyłanie wiadomości z paragonem</div>
        ...
        <?php
            ...
            if ((int)$db->ile_rekordow($sql) > 0 && (int)$_GET['id'] > 0) {
                ...
                <form action="sprzedaz/zamowienia_paragon_wyslij_mail.php?id_poz=<?php echo $_GET['id_poz']; ?>&id=<?php echo $_GET['id']; ?>" method="post" id="emailForm" class="cmxform">          

                  <div class="poleForm">

                    <div class="naglowek">Wysłanie wiadomości e-mail z paragonem do klienta</div>
                    ...
                    <div class="pozycja_edytowana">
                        ...
                        <div class="info_content">
                          ...
                          <?php
                          $zapytanieTresc = "select * from email_text et, email_text_description etd where et.email_var_id = 'EMAIL_WYGENEROWANY_PARAGON' and et.email_text_id = etd.email_text_id and etd.language_id = '" . (int)$_GET['jezyk'] . "'";
                          ...
                          <p class="JezykiMailaFaktura">
                            ...
                            while ($infe = $sqlJezykow->fetch_assoc()) {
                                echo '<a ' . (($infe['languages_id'] == (int)$_GET['jezyk']) ? 'class="AktywnyJezyk"' : '') . ' href="sprzedaz/zamowienia_paragon_wyslij_mail.php?id_poz=' . (int)$_GET['id_poz'] . '&id=' . (int)$_GET['id'] . '&jezyk=' . $infe['languages_id'] . '">' . $infe['name'] . '</a>';
                            }
