...
if ($prot->wyswietlStrone) {
    ...
    if (isset($_POST['akcja']) && $_POST['akcja'] == 'zapisz') {
        ...
        if ( isset($_POST['email']) && $_POST['email'] != '') {
            ...
            $zapytanie_tresc = "SELECT t.sender_name, t.email_var_id, t.sender_email, t.dw, t.template_id, t.email_file, tz.email_title, tz.description, tz.description_sms FROM email_text t LEFT JOIN email_text_description tz ON tz.email_text_id = t.email_text_id AND tz.language_id = '".(int)$_SESSION['domyslny_jezyk']['id']."' WHERE t.email_var_id = 'OPINIA_O_SKLEPIE'";
        ...
        Funkcje::PrzekierowanieURL('zamowienia_wyslij_email_o_opinie.php?id_poz=' . (int)$_POST["id"] . '&wyslano');
    }
    ...
    <div id="naglowek_cont">Wysłanie wiadomości e-mail z prośbą o opinię o sklepie</div>
    <div id="cont">
        ...
        ?>
            ...
            <div class="poleForm">
                ...
                <div class="naglowek">Wysłanie wiadomości e-mail z prośbą o opinię o sklepie</div>
        ...
        <?php
            ...
            ?>
              ...
              <form action="sprzedaz/zamowienia_wyslij_email_o_opinie.php" method="post" id="emailForm" class="cmxform">    
                ...
                <div class="poleForm">
                  ...
                  <div class="pozycja_edytowana">
                    ...
                    <div class="info_content">
                      ...
                      //
                      // podmiana danych
                      define('LINK_DO_FORMULARZA_OPINII', ADRES_URL_SKLEPU . '/napisz-opinie-o-sklepie.html/opinia=' . $zamowienie->link_opinii);
                      //
