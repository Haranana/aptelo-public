...
if ($prot->wyswietlStrone) {
    ...
    if (isset($_POST['akcja']) && $_POST['akcja'] == 'zapisz') {
        ...
        $db->delete_query('standard_order_comments_description' , " comments_id = '".(int)$_POST["id"]."'");        
    ...
    <div id="naglowek_cont">Edycja komentarza zamówienia dla statusu - <?php echo Sprzedaz::pokazNazweStatusuZamowienia((int)$_GET['status_id'], $_SESSION['domyslny_jezyk']['id']); ?></div>
    <div id="cont">
          ...
          <div class="poleForm">
            ...
            $zapytanie = "select * from standard_order_comments where comments_id = '" . (int)$_GET['id_poz'] . "' and status_id = '" . (int)$_GET['status_id'] . "'";
                ...
                <div class="pozycja_edytowana">
                    ...
                    <div class="info_tab_content">
                        ...
                        for ($w = 0, $c = count($ile_jezykow); $w < $c; $w++) {
                            ...
                            $zapytanie_jezyk = "select distinct * from standard_order_comments_description where comments_id = '".(int)$_GET['id_poz']."' and languages_id = '" .$ile_jezykow[$w]['id']."'";
