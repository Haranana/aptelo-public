              ...
              <form action="sprzedaz/zamowienia_etykiety_adresowe_pdf.php" method="post" id="wynikForm" class="cmxform">  
                  ...
                  <table class="listing_tbl">
                    ...
                    while ($info = $sql->fetch_assoc()) {
                      ...
                      echo '<tr class="item-row FakturaProduktEtykiety">';
                      ...
                      echo '<td class="FakturaProdukt"><textarea cols="100" rows="4" name="wiersz['.$i.'][adresat]">'.$adresat.'</textarea></td>';
                      echo '</tr>';
                    ...
                    <tr id="hiderow">
                      <td colspan="3" style="padding:20px"><a id="addrow" href="javascript:void(0)" class="dodaj">dodaj pozycję</a></td>
                    </tr>
                  ...
                  <p>
                    ...
                    echo Funkcje::RozwijaneMenu('id', $tablica, $domyslna );
                    unset($tablica);
                    ?>
                  </p>
                  ...
                  <p>
                    ...
                    <input type="text" name="offset" id="offset" value="0" /> <em class="TipIkona"><b>Pozycja na arkuszu etykiet, od której rozpocząć drukowanie; 0 - od początku</b></em>
                  </p>

                  <p>
                    <label>Czy drukować ramkę:</label>
                    <input type="radio" value="0" name="ramka" id="ramka_nie" <?php echo ( $ramka == '1' ? 'checked="checked"' : '' ); ?> /> <label class="OpisFor" for="ramka_nie">nie</label>
                    <input type="radio" value="1" name="ramka" id="ramka_tak" <?php echo ( $ramka == '0' ? 'checked="checked"' : '' ); ?> /> <label class="OpisFor" for="ramka_tak">tak</label>                 
                  </p>
