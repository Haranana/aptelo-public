...
if ($IloscProduktow > 0) { 
    ...
    echo '<div class="OknaRwd Kol-' . LISTING_ILOSC_KOLUMN . ' KolMobile-' . LISTING_ILOSC_KOLUMN_MOBILE . ' ListingOknaKontener">';
    ...
    while ($info = $sql->fetch_assoc()) {
        ...
        echo '<div id="prd-' . rand(1,1000) . '-' . $info['products_id'] . '" class="Okno OknoRwd' . (($Produkt->zakupy['mozliwe_kupowanie'] == 'tak' || $Produkt->zakupy['pokaz_koszyk'] == 'tak') ? '' : ' ProduktBezZakupu') . (($GLOBALS['koszykKlienta']->SprawdzCzyDodanyDoKoszyka($Produkt->info['id'])) ? ' ProduktDodanyDoKoszyka' : '') . '">';

            // klasa do wysuwanego przycisku animacji
            echo '<div class="AnimacjaZobacz ElementListingRamka">';
                ...
                echo '<div class="ZakupKontener">';
                    ...
                    if (LISTING_POROWNYWARKA_PRODUKTOW == 'tak' || PRODUKT_SCHOWEK_STATUS == 'tak') {
                    
                        echo '<div class="PorownajSchowek">';
    ...
    if ( LISTING_PRODUKTOW_OSTATNIA_POZYCJA == 'tak' ) {
         ...
         if ( $KolejnaStronaOkno != '' ) {
              //
              echo '<div class="Okno OknoRwd OknoKolejnaStrona">
