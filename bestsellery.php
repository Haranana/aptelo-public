...
if (POKAZUJ_FILTRY_NOWOSCI == 'tak') {
    $srodek->dodaj('__FILTRY_NOWOSCI', Filtry::FiltrNowosciSelect('', 'bestsellery'));
} else {
...
if (POKAZUJ_FILTRY_PROMOCJE == 'tak') {
    $srodek->dodaj('__FILTRY_PROMOCJE', Filtry::FiltrPromocjeSelect('', 'bestsellery'));        
} else {
...
if (POKAZUJ_FILTRY_DOSTEPNOSCI == 'tak') {
    $srodek->dodaj('__FILTRY_DOSTEPNOSCI', Filtry::FiltrDostepnoscSelect( '', 'bestsellery' ));
} else {
...
if (POKAZUJ_FILTRY_CZAS_WYSYLKI == 'tak') {
    $srodek->dodaj('__FILTRY_CZAS_WYSYLKI', Filtry::FiltrCzasWysylkiSelect( '', 'bestsellery' ));
} else {
